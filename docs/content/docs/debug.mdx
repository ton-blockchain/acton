...
Acton works best with official IDE integrations such as [TON VSCode extension](/docs/ide-support/vscode) and [TON JetBrains plugin](/docs/ide-support/jetbrains). Other DAP clients can attach too, but they should expect only the subset of requests and scopes that Acton implements today.
