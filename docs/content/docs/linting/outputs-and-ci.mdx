...
<Callout>
  TODO: should just become a part of ci-setup.mdx, and the linting/index.mdx plus linting/configuration would become a single howto page. Didn't make the change as to not perform content edits yet.
</Callout>
