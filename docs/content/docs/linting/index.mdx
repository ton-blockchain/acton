...
It supports project-wide checks, target-specific checks, automatic fixes, JSON output, SARIF reports, and GitHub annotations.
...
<Cards>
  ...
  <Card href="/docs/linting/outputs-and-ci" title="Outputs and CI">
    Use JSON, SARIF, and GitHub outputs, and configure CI behavior via exit codes and warning thresholds.
  </Card>
