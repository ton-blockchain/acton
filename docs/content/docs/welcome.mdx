...
<Cards>
    ...
    <Card href="/docs/quickstart" title="Quickstart">
        Quickly familiarize yourself with Acton through the Tolk smart contract made from a template.
    </Card>
...
- CLI help: `acton --help` for the overview, `acton help <command>` for the long manual, and `<nested> --help` for nested subcommands. For example, `acton wallet list --help`.
