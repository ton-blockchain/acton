...
Acton is an all-in-one TON smart contract development toolkit written in Rust. It combines project scaffolding, build, testing, scripting, wallet and network operations, verification, linting, formatting, and low-level VM tooling in one CLI, with [Acton Studio](/docs/studio) as its browser workspace.
...
- Develop and test applications in virtual environments: simulator networks and full localnets.
- Transition from local tests to virtual environments to real networks with the same comprehensive Studio UI.

## New in Acton 1.2

<AvailabilityBadge since="Acton 1.2" />

Use [Studio](/docs/studio#dashboard) for project tests and environments,
[Simulator](/docs/environments/simulator/overview) for lightweight execution and forks, and
...
<Cards>
    ...
    <Card href="/docs/studio" title="Acton Studio">
        Accelerate development with virtual environments and universal UI.
    </Card>
