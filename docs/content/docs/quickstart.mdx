...
<Steps>
    ...
    <Step title="Setup Wallet">
        ...
        In interactive mode, Acton will also ask if you want to request testnet TON from faucet right after wallet creation.

        If you run non-interactively (for example in CI), use `--airdrop` to request faucet funds automatically:
        ...
        If you skip faucet request (or it fails), you can still fund your wallet from the **[Testnet Giver Bot](https://t.me/testgiver_ton_bot)** by sending your wallet address.
    </Step>
