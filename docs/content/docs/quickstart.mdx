...
<Callout>
    We won't dive deep into the specific details of the contract logic here. To learn more about Tolk and smart contract development, check out [Your first smart contract](https://docs.ton.org/first-smart-contract) in the official documentation.
</Callout>
