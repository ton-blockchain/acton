...
Acton first sends the compiled code hash to `/api/v1/take_ticket`. If that code hash is verified, Acton stops successfully and does not request wallet access.
