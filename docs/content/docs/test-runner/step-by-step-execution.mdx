...
[`testing.saveSnapshot()`](/docs/standard_library/emulation/testing/#testingsavesnapshot) and [`testing.loadSnapshot()`](/docs/standard_library/emulation/testing/#testingloadsnapshot), or see [World State Snapshots](/docs/test-runner/world-state-snapshots/).
