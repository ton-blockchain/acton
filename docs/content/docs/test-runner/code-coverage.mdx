...
───────────────────────────────────────────────────────────────────────────────────────
 ...
 contracts/JettonWallet.tolk                                57            68     83.8% 
 contracts/JettonMinter.tolk                                54            56     96.4% 
 contracts/fees-management.tolk                              1             1    100.0% 
 contracts/jetton-utils.tolk                                 9             9    100.0% 
 contracts/storage.tolk                                      4             4    100.0% 
 contracts/errors.tolk                                       3             3    100.0%
```
