...
<Callout type="tip">
  Use [Acton Studio](/docs/studio) and simulator networks to [connect the frontend](/docs/environments/connect) through the generated client and TON Connect settings.
</Callout>
