...
<Callout title="Learn more">
  For a deep dive into how libraries work in TON, check out the [official documentation](https://docs.ton.org/contract-dev/techniques/using-on-chain-libraries).
</Callout>
...
For account state transitions (`active`/`frozen`/`nonexist`) and storage debt behavior, see TON docs: [Address states](https://docs.ton.org/foundations/status).
