...
Use [`acton script`](/docs/commands/script) to run Tolk scripts in the same local emulation environment as tests. Additionally, scripts can be broadcast to run on the testnet or mainnet.
