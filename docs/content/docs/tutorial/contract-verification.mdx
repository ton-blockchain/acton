...
3.  **Wallet is configured**: You need a configured wallet with a small amount of TON (~0.5 TON recommended, 0.1 TON is the fee) to send the verification transaction. See [Setting up wallets](/docs/tutorial/setup-wallets/).
