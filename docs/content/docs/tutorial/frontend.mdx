...
<Files>
  <Folder name="app" description="dApp project root (package.json, vite.config.ts)" defaultOpen>
    ...
    <Folder name="wrappers-ts" description="Folder with TypeScript wrappers" />
  </Folder>
</Files>
...
Open [http://127.0.0.1:5173/?testnet=true](http://127.0.0.1:5173/?testnet=true). The page shows:
...
- Deploy and vote scripts for local emulation and testnet
