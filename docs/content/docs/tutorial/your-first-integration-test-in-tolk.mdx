...
<Callout type="tip">
In this guide, we will write a wrapper manually to understand how it works under the hood. In real projects, you can generate wrappers automatically using the [`wrapper`](/docs/testing/generating-wrappers) command.
</Callout>
