...
To deploy to testnet, your wallet must have testnet TONs. You can get them for free with the `acton wallet airdrop` command or by following the official TON testnet funding instructions.
