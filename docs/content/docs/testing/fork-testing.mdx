...
<Callout type="tip">
  Fork tests stay in the local emulator. For a persistent fork shared by scripts and frontends, use a [simulator network](/docs/environments/fork-and-import) in the [Acton Studio](/docs/studio).
</Callout>
