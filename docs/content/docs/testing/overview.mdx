...
## Run selected paths and inspect results in Studio
...
Use `--no-capture` for live test output. Start `acton studio` to retain test history
and inspect results in the [Studio workspace](/docs/studio/tests).
