...
<Callout type="tip">
  [Acton Studio](/docs/studio) integrates all [Test UI](/docs/testing/test-ui/overview) capabilities in <kbd>[Local tests](/docs/studio#local-tests)</kbd>, alongside project-wide test run history.
</Callout>
