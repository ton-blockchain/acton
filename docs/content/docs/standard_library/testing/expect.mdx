...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/testing/expect.tolk#L693" />
...
This mirrors Foundry-style `bound` behavior for fuzzed scalar inputs:
values already in range stay unchanged, while out-of-range values wrap back
into the target interval.

<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/testing/expect.tolk#L706" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/testing/expect.tolk#L767" />
