...
Behavior:
- If no wallets are configured, returns `""`.
...
- In non-interactive mode, returns `""`.
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/promts/prompts.tolk#L88" />
