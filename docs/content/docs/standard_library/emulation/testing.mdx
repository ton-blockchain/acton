...
In contrast to [net.send](../network/#netsend), this method executes exactly one transaction and
does not recursively process that transaction's out messages. The returned
[SendResult](../network/#sendresult) still contains those out messages for inspection, but they are
left undelivered.
...
See [net.send](../network/#netsend) or [net.sendExternal](../network/#netsendexternal) if you need full recursive trace processing.

<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L124" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L139" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L146" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L163" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L206" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L221" />
...
- the current VM context's C7 unixtime slot, so `blockchain.now()` in the
  current test/get-method context immediately sees the same mocked value
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L242" />
...
[testing.setNow](#testingsetnow). If the emulated time is still `0` (the default before any
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L262" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L275" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L294" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L309" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L324" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L336" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L374" />
...
by [testing.getConfig](#testinggetconfig). `testing.setConfig()` is the commit point that
...
- the current VM context's C7 config mirrors (both packed root config and
  the unpacked hot fields used by TVM helpers)

That extra C7 synchronization keeps the current test context, follow-up
config getters, and emulated execution paths aligned on the same config data
without requiring a fresh VM bootstrap.
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L425" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L484" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L504" />
...
<SourceCodeLink href="https://github.com/ton-blockchain/acton/blob/master/lib/emulation/testing.tolk#L515" />
