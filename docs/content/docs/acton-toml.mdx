...
```toml
[mappings]
"utils" = "./libs/utils" # Equivalent to "@utils"
"@core" = "./libs/core"
```
...
```tolk
import "@core/math.tolk"  // Resolves to ./libs/core/math.tolk
import "@utils/logic.tolk" // Resolves to ./libs/utils/logic.tolk
```

### Prefix Resolution Rules

- **Longest Match First**: If you have multiple nested mappings (e.g., `@core` and `@core/utils`), Acton will use the longest matching prefix for resolution.
