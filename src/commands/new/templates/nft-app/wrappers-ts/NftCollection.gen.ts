...
export class NftCollection implements c.Contract {
    static CodeCell = c.Cell.fromBase64('');
    ...
    async getNftContent(provider: ContractProvider, _itemIndex: bigint, individualNftContent: string): Promise<CellRef<OffchainMetadataReply>> {
        const r = StackReader.fromGetMethod(1, await provider.get('get_nft_content', [
            { type: 'int', value: _itemIndex },
            { type: 'cell', cell: beginCell().storeStringTail(individualNftContent).endCell() },
        ]));
