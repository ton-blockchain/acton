...
- When the SimpleExtension ABI changes, prefer regenerating `wrappers/SimpleExtension.gen.tolk` with `acton wrapper SimpleExtension` over hand-editing the generated wrapper file.
