...
- Keep `contracts/tests/`, `contracts/wrappers/Counter.tolk`, `contracts/scripts/deploy.tolk`, `wrappers-ts/Counter.ts`, and the frontend code in `app/` aligned with contract changes.
