...
export const IncreaseCounter = {
  ...
  create(args: { increaseBy: uint32 }): IncreaseCounter {
    return {
      $: 'IncreaseCounter',
      ...args,
    };
...
export const DecreaseCounter = {
  ...
  create(args: { decreaseBy: uint32 }): DecreaseCounter {
    return {
      $: 'DecreaseCounter',
      ...args,
    };
...
export const Storage = {
  create(args: { id: uint32; counter: uint32 }): Storage {
    return {
      $: 'Storage',
      ...args,
    };
...
export class Counter implements c.Contract {
  static CodeCell = c.Cell.fromBase64(
    'te6ccgEBBAEAmQABFP8A9KQT9LzyyAsBAgFiAgMA7tD4kZEw4CDXLCP0Oyd8jhgx7UTQAdcLHwHWH9cLH1igAcjOyx/J7VTg1ywhQdph/I4gMe1E0AHXCx8B1h/XCx+BEAFTE77y9FihAcjOyx/J7VTg1ywh06l4NDGOEjDtRNDWHzDIzs+QAAAAAsntVOCEDwHHAPL0ABehlaHaiaGmPmOuFj8=',
  );
  ...
  static createCellOfIncreaseCounter(body: { increaseBy: uint32 }) {
    return IncreaseCounter.toCell(IncreaseCounter.create(body));
  }

  static createCellOfDecreaseCounter(body: { decreaseBy: uint32 }) {
  ...
  async getCurrentCounter(provider: ContractProvider): Promise<bigint> {
    const r = StackReader.fromGetMethod(
      1,
      await provider.get('currentCounter', []),
    );
    return r.readBigInt();
  }
}
