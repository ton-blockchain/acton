...
With `--all`, Acton checks for conflicting wrapper names before writing any files.
Names must remain distinct after PascalCase conversion, ignoring letter case.
This also prevents overwrites on case-insensitive filesystems.
