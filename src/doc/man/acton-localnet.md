...
In periodic block mode, the faucet request is queued and the command reports it
as queued; the balance changes after the next produced block includes the
message.
