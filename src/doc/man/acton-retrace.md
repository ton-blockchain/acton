...
2. Force mainnet and use an API key from the environment:
   ...
   ```bash
   TONCENTER_MAINNET_API_KEY=your-key acton retrace \
   3c1b02a33390e596d83b306eab57b3f7271bc90e2e527ea4cafccfde25139d41 --net mainnet
   ```
