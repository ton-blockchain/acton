...
#[openapi(
    ...
    paths(
        ...
        crate::import_environment_snapshot,
        crate::export_environment_snapshot,
    ...
    components(schemas(
        ...
        EnvironmentStartupOperation,
        EnvironmentStartupState,
        acton_localnet::OperationProgress,
        acton_localnet::OperationStep,
