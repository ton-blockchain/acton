...
use acton_localnet::{
    ...
    NetworkHealthStatus, OperationProgress, OperationStep, ServiceHealth, ServiceHealthStatus,
};
use acton_studio::{
    ...
    EnvironmentSnapshotOperationPhase, EnvironmentStartupOperation, EnvironmentStartupState,
    EnvironmentStatus, FullTonNode, RemoveFullTonNodeRequest, STUDIO_ENVIRONMENTS_PATH,
...
struct TestEnvironmentRuntime {
    startup_wallets: Arc<Mutex<Vec<acton_localnet::StartupWallet>>>,
    next_id: AtomicU64,
...
impl EnvironmentRuntime for TestEnvironmentRuntime {
        ...
        Box::pin(async move {
            let (config, runtime_endpoints) = match request.config {
                ...
                CreateEnvironmentConfig::FullTonNetwork {
                    ...
                    *self.startup_wallets.lock().expect("startup wallets lock") = startup_wallets;
    ...
    fn startup_state(
        ...
        Box::pin(async move {
            Ok(EnvironmentStartupState {
                operation: Some(EnvironmentStartupOperation {
                    phase: "pullingImage".to_owned(),
                    progress: Some(OperationProgress {
                        completed: 42,
                        total: Some(100),
                        unit: "percent".to_owned(),
                        detail: "Downloading Localton image".to_owned(),
                    }),
                    completed_steps: vec![OperationStep {
                        phase: "checkingImage".to_owned(),
                        duration_ms: 18,
                    }],
                }),
    ...
    fn set_full_ton_node_running(
        ...
        Box::pin(async move {
            let mut environments = self.environments.lock().expect("environment lock");
            let environment = environments
                .iter_mut()
                .find(|environment| environment.id == environment_id)
                .ok_or_else(|| EnvironmentRuntimeError::NotFound {
            ...
            let EnvironmentConfig::FullTonNetwork { nodes, .. } = &mut environment.config else {
                panic!("node lifecycle fixture requires a full network")
            };
            let node = nodes
                .iter_mut()
                .find(|node| node.id == node_id)
                .expect("managed fixture node");
...
fn snapshot_fixture(id: &str, name: Option<String>) -> EnvironmentSnapshot {
    EnvironmentSnapshot {
        ...
        state_size_bytes: Some(125_000_000),
        masterchain_seqno: Some(42),
    }
}
...
async fn snapshot_routes_return_long_running_operation_state() {
    ...
    expect![[r#"
        ...
        LIST
        status: 200 OK
        body: [{"id":"snapshot-1","name":"Before upgrade","createdAt":1786000000,"sizeBytes":52000000,"stateSizeBytes":125000000,"masterchainSeqno":42}]
...
async fn environment_create_list_stop_and_restart_share_one_api_contract() {
    ...
    expect![[r#"
        CREATE
        status: 201 Created
        body: {"id":"test-environment-1","name":"Forked mainnet","status":"running","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"actonSimulatedLocalnet","port":5511,"forkNetwork":"mainnet","forkBlockNumber":81973221,"accounts":["deployer","treasury"],"rateLimit":30,"responseDelayMs":120,"blockTimeMs":750,"noMining":false,"mineEmptyBlocks":true},"capabilities":["apiV2","apiV3","controlApi","explorer","integration","gramFaucet","jettonFaucet","wallets","simulator","contracts","apiCalls","mining","timeTravel","snapshots"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","control":"/api/v1/environments/test-environment-1/rpc"},"network":{"id":"mainnet","label":"Mainnet fork","chainId":-3,"testOnly":true,"supportsActions":false}}

        LIST
        status: 200 OK
        body: [{"id":"testnet","name":"Testnet","status":"running","lifecycle":"external","rpcUrl":"/api/v1/environments/testnet/rpc","config":{"kind":"remoteTonNetwork","network":"testnet"},"capabilities":["apiV2","apiV3","explorer","integration","testnetFaucet","wallets","simulator","contracts","apiCalls"],"endpoints":{"apiV2":"/api/v1/environments/testnet/rpc/api/v2","apiV3":"/api/v1/environments/testnet/rpc/api/v3"},"network":{"id":"testnet","label":"Testnet","chainId":-3,"testOnly":true,"supportsActions":true}},{"id":"mainnet","name":"Mainnet","status":"running","lifecycle":"external","rpcUrl":"/api/v1/environments/mainnet/rpc","config":{"kind":"remoteTonNetwork","network":"mainnet"},"capabilities":["apiV2","apiV3","explorer","integration","wallets","simulator","contracts","apiCalls"],"endpoints":{"apiV2":"/api/v1/environments/mainnet/rpc/api/v2","apiV3":"/api/v1/environments/mainnet/rpc/api/v3"},"network":{"id":"mainnet","label":"Mainnet","chainId":-239,"testOnly":false,"supportsActions":true}},{"id":"test-environment-1","name":"Forked mainnet","status":"running","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"actonSimulatedLocalnet","port":5511,"forkNetwork":"mainnet","forkBlockNumber":81973221,"accounts":["deployer","treasury"],"rateLimit":30,"responseDelayMs":120,"blockTimeMs":750,"noMining":false,"mineEmptyBlocks":true},"capabilities":["apiV2","apiV3","controlApi","explorer","integration","gramFaucet","jettonFaucet","wallets","simulator","contracts","apiCalls","mining","timeTravel","snapshots"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","control":"/api/v1/environments/test-environment-1/rpc"},"network":{"id":"mainnet","label":"Mainnet fork","chainId":-3,"testOnly":true,"supportsActions":false}}]

        UPDATE
        status: 200 OK
        body: {"id":"test-environment-1","name":"Renamed environment","status":"running","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"actonSimulatedLocalnet","port":5511,"forkNetwork":"mainnet","forkBlockNumber":81973221,"accounts":["deployer","treasury"],"rateLimit":30,"responseDelayMs":120,"blockTimeMs":750,"noMining":false,"mineEmptyBlocks":true},"capabilities":["apiV2","apiV3","controlApi","explorer","integration","gramFaucet","jettonFaucet","wallets","simulator","contracts","apiCalls","mining","timeTravel","snapshots"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","control":"/api/v1/environments/test-environment-1/rpc"},"network":{"id":"mainnet","label":"Mainnet fork","chainId":-3,"testOnly":true,"supportsActions":false}}

        STOP
        status: 200 OK
        body: {"id":"test-environment-1","name":"Renamed environment","status":"stopped","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"actonSimulatedLocalnet","port":5511,"forkNetwork":"mainnet","forkBlockNumber":81973221,"accounts":["deployer","treasury"],"rateLimit":30,"responseDelayMs":120,"blockTimeMs":750,"noMining":false,"mineEmptyBlocks":true},"capabilities":["apiV2","apiV3","controlApi","explorer","integration","gramFaucet","jettonFaucet","wallets","simulator","contracts","apiCalls","mining","timeTravel","snapshots"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","control":"/api/v1/environments/test-environment-1/rpc"},"network":{"id":"mainnet","label":"Mainnet fork","chainId":-3,"testOnly":true,"supportsActions":false}}

        RESTART
        status: 200 OK
        body: {"id":"test-environment-1","name":"Renamed environment","status":"starting","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"actonSimulatedLocalnet","port":5511,"forkNetwork":"mainnet","forkBlockNumber":81973221,"accounts":["deployer","treasury"],"rateLimit":30,"responseDelayMs":120,"blockTimeMs":750,"noMining":false,"mineEmptyBlocks":true},"capabilities":["apiV2","apiV3","controlApi","explorer","integration","gramFaucet","jettonFaucet","wallets","simulator","contracts","apiCalls","mining","timeTravel","snapshots"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","control":"/api/v1/environments/test-environment-1/rpc"},"network":{"id":"mainnet","label":"Mainnet fork","chainId":-3,"testOnly":true,"supportsActions":false}}
...
#[tokio::test]
async fn full_ton_startup_wallets_are_resolved_server_side() {
    use acton_studio::{StudioWallet, WalletRuntime, WalletRuntimeError, WalletRuntimeFuture};

    struct ProjectWallets;

    impl WalletRuntime for ProjectWallets {
        fn prepare_localnet_accounts(
            ...
            Box::pin(async move {
                names
                    ...
                    .map(|name| {
                        if name != "deployer" {
                            return Err(WalletRuntimeError::NotFound { wallet_name: name });
                        }
                        Ok(acton_localnet::StartupWallet {
                            name,
                            shard_account_boc_hex: "resolved on server".into(),
                        })
                    })
                    .collect()
            })
        ...
        fn list(&self, _: &StudioEnvironment) -> WalletRuntimeFuture<'_, Vec<StudioWallet>> {
        ...
        fn sign(
            ...
            unreachable!("creating an environment must not request signatures")
        }
    }

    let runtime = TestEnvironmentRuntime::default();
    let prepared = Arc::clone(&runtime.startup_wallets);
    let app = StudioServer::new(StudioServerConfig::new("test"))
        .with_environment_runtime(runtime)
        .with_wallet_runtime(ProjectWallets)
        .router();
    let mut results = Vec::new();
    for accounts in [json!(["deployer"]), json!([]), json!(["missing"])] {
        let response = app.clone().oneshot(Request::post(STUDIO_ENVIRONMENTS_PATH)
            .header("content-type", "application/json")
            .body(Body::from(json!({
                "name": "wallet network",
                "config": {
                    "kind": "fullTonNetwork", "accounts": accounts,
                    "startupWallets": [{"name": "injected", "shardAccountBocHex": "client state"}],
                },
        ...
        let body: Value =
            serde_json::from_slice(&to_bytes(response.into_body(), usize::MAX).await.unwrap())
                .unwrap();
        results.push(json!({
            "status": status.as_u16(), "accounts": body["config"]["accounts"],
            "internalStateExposed": body["config"].get("startupWallets").is_some(),
            "resolved": *prepared.lock().unwrap(), "error": body["error"],
        }));
    }
    expect![[r#"
        [
          {
            ...
            "resolved": [
              {
                "name": "deployer",
                "shardAccountBocHex": "resolved on server"
              }
            ],
            "status": 201
          },
          ...
          },
          {
            ...
            "error": {
              ...
              "message": "Wallet missing was not found"
            },
            "internalStateExposed": false,
            "resolved": [],
            "status": 400
    ...
    .assert_eq(&serde_json::to_string_pretty(&results).unwrap());
}
...
#[tokio::test]
async fn full_ton_startup_state_is_forwarded_through_the_catalog_runtime() {
    let app = router();
    app.clone()
        .oneshot(
            Request::post(STUDIO_ENVIRONMENTS_PATH)
    ...
    let response = app
        .oneshot(
            Request::get("/api/v1/environments/test-environment-1/startup?tail=12")
                .body(Body::empty())
                .expect("startup request must be valid"),
        )
        .await
        .expect("startup request must succeed");
    let actual = response_snapshot(response).await;

    expect![[r#"
        status: 200 OK
        body: {"operation":{"phase":"pullingImage","progress":{"completed":42,"total":100,"unit":"percent","detail":"Downloading Localton image"},"completedSteps":[{"phase":"checkingImage","durationMs":18}]},"logs":"last 12 startup lines"}"#]]
    .assert_eq(&actual);
}
...
async fn full_ton_environment_adds_a_node_to_the_existing_network() {
    ...
    expect![[r#"
        status: 201 Created
        body: {"id":"test-environment-1","name":"Protocol network","status":"running","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"fullTonNetwork","apiV2Port":18080,"apiV3Port":18081,"adminPort":18082,"configPort":18083,"observabilityPort":18084,"importedAccounts":[],"accounts":[],"nodes":[{"id":"node-1","name":"node-a","validator":false,"portBase":19000,"stopped":false}]},"capabilities":["apiV2","apiV3","configApi","controlApi","explorer","integration","gramFaucet","wallets","simulator","contracts","apiCalls","snapshots","observability","health"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","config":"/api/v1/environments/test-environment-1/rpc/config","control":"/api/v1/environments/test-environment-1/rpc","observability":"/api/v1/environments/test-environment-1/observability"},"network":{"id":"full-ton-network","label":"Localnet","chainId":-3,"testOnly":true,"supportsActions":true}}"#]]
    .assert_eq(&actual);
}

#[tokio::test]
async fn full_ton_environment_stops_and_starts_a_managed_node() {
    let app = router();
    app.clone()
        .oneshot(
            Request::post(STUDIO_ENVIRONMENTS_PATH)
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{"name":"Protocol network","config":{"kind":"fullTonNetwork"}}"#,
                ))
    ...
    for action in ["stop", "start"] {
        let response = app
            ...
            .oneshot(
                Request::post(format!(
                    "/api/v1/environments/test-environment-1/nodes/node-1/{action}"
                ))
                .body(Body::empty())
                .expect("node lifecycle request"),
            )
            .await
            .expect("node lifecycle response");
    ...
    .assert_eq(&serde_json::to_string_pretty(&transitions).expect("transitions"));
}
...
async fn full_ton_environment_removes_a_managed_node() {
    ...
    expect![[r#"
        status: 200 OK
        body: {"id":"test-environment-1","name":"Protocol network","status":"running","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"fullTonNetwork","apiV2Port":18080,"apiV3Port":18081,"adminPort":18082,"configPort":18083,"observabilityPort":18084,"importedAccounts":[],"accounts":[],"nodes":[]},"capabilities":["apiV2","apiV3","configApi","controlApi","explorer","integration","gramFaucet","wallets","simulator","contracts","apiCalls","snapshots","observability","health"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","config":"/api/v1/environments/test-environment-1/rpc/config","control":"/api/v1/environments/test-environment-1/rpc","observability":"/api/v1/environments/test-environment-1/observability"},"network":{"id":"full-ton-network","label":"Localnet","chainId":-3,"testOnly":true,"supportsActions":true}}"#]]
    .assert_eq(&actual);
}
...
async fn full_ton_environment_starts_a_managed_validator_exit() {
    ...
    expect![[r#"
        status: 202 Accepted
        body: {"id":"test-environment-1","name":"Protocol network","status":"running","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"fullTonNetwork","apiV2Port":18080,"apiV3Port":18081,"adminPort":18082,"configPort":18083,"observabilityPort":18084,"importedAccounts":[],"accounts":[],"nodes":[{"id":"node-1","name":"validator-a","validator":true,"portBase":19000,"stopped":false}]},"capabilities":["apiV2","apiV3","configApi","controlApi","explorer","integration","gramFaucet","wallets","simulator","contracts","apiCalls","snapshots","observability","health"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","config":"/api/v1/environments/test-environment-1/rpc/config","control":"/api/v1/environments/test-environment-1/rpc","observability":"/api/v1/environments/test-environment-1/observability"},"network":{"id":"full-ton-network","label":"Localnet","chainId":-3,"testOnly":true,"supportsActions":true}}"#]]
    .assert_eq(&actual);
}
...
async fn full_ton_environment_starts_a_managed_validator_entry() {
    ...
    expect![[r#"
        status: 202 Accepted
        body: {"id":"test-environment-1","name":"Protocol network","status":"running","lifecycle":"managed","rpcUrl":"/api/v1/environments/test-environment-1/rpc","config":{"kind":"fullTonNetwork","apiV2Port":18080,"apiV3Port":18081,"adminPort":18082,"configPort":18083,"observabilityPort":18084,"importedAccounts":[],"accounts":[],"nodes":[{"id":"node-1","name":"node-a","validator":true,"portBase":19000,"stopped":false}]},"capabilities":["apiV2","apiV3","configApi","controlApi","explorer","integration","gramFaucet","wallets","simulator","contracts","apiCalls","snapshots","observability","health"],"endpoints":{"apiV2":"/api/v1/environments/test-environment-1/rpc/api/v2","apiV3":"/api/v1/environments/test-environment-1/rpc/api/v3","config":"/api/v1/environments/test-environment-1/rpc/config","control":"/api/v1/environments/test-environment-1/rpc","observability":"/api/v1/environments/test-environment-1/observability"},"network":{"id":"full-ton-network","label":"Localnet","chainId":-3,"testOnly":true,"supportsActions":true}}"#]]
    .assert_eq(&actual);
}
