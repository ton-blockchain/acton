...
pub const FIFT_TARGET: &str = "ton_language_server_core::languages::fift";
pub const TOLK_TARGET: &str = "ton_language_server_core::languages::tolk";
pub const TOML_TARGET: &str = "ton_language_server_core::languages::toml";
