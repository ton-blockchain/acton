...
pub(crate) fn parse_name_and_section(text: &str) -> Result<(&str, u8), Error> {
...
pub(crate) fn header_text<'e>(parser: &mut EventIter<'e>) -> Result<CowStr<'e>, Error> {
...
pub(crate) fn unwrap<'t>(text: &'t str, front: &str, back: &str) -> &'t str {
