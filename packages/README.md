...
The `packages` workspace contains shared libraries, web applications, UI components, and browser tests used by Acton.
...
| [`@acton/faucet-ui`](./faucet-ui)               | Shared testnet GRAM request page, API client, and PoW worker used by Actonscan, Studio, and the standalone faucet frontend.                                                                 |
