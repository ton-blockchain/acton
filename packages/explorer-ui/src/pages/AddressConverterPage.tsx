...
import {AddressFormats} from "@acton/explorer-core/components/AddressFormats"
      ...
      <div className={styles.workspace}>
        {result?.address ? (
          <>
            ...
            <AddressFormats
              address={result.address.toRawString()}
              addressFormat={{testOnly: false}}
              includeTestnet
              onAddressClick={(address, testOnly) => {
                const search = new URLSearchParams(accountSearch)
                ...
                // The app initializes its API client from the URL; crossing networks must load that context too.
