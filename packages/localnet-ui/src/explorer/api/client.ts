...
export class TonClient {
  ...
  async getStartupAccounts(): Promise<StartupAccount[]> {
    const url = this.buildUrl(this.addressNameBaseUrl, "/acton_getStartupAccounts")
    return this.request(url, "Failed to fetch startup accounts")
  }
