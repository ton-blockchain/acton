//! Reserved integration test module for subagent DJ.
//!
//! Ownership boundary for agent DJ:
//! - tests/integration/test_std_agent_dj_tests.rs
//! - tests/integration/snapshots/test_std_agent_dj/**
//! - tests/integration/testdata/test_std_agent_dj/**
//! - tests/support/test_std_agent_dj/** (optional)
//!
...
fn run_dj_vm_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn dj_stdlib_vm_set_block_and_logical_time_are_independent_in_c7_slots() {
    run_dj_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dj/dj_stdlib_vm_set_block_and_logical_time_are_independent_in_c7_slots.stdout.txt",
    );
}

#[test]
fn dj_stdlib_vm_set_logical_then_block_time_preserves_slot_isolation_in_fixture_project() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_dj/dj_stdlib_vm_set_logical_then_block_time_preserves_slot_isolation_in_fixture_project.stdout.txt",
        );
}
