...
//! - tests/integration/test_std_agent_z_tests.rs
//! - tests/integration/snapshots/test_std_agent_z/**
...
fn z_stdlib_env_parses_int_bool_address_and_cell_in_supported_formats() {
    ...
    ProjectBuilder::new("z-stdlib-env-supported-formats")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_z/z_stdlib_env_parses_int_bool_address_and_cell_in_supported_formats.stdout.txt",
        );
}

#[test]
fn z_stdlib_env_returns_null_for_invalid_inputs_and_missing_values() {
    ProjectBuilder::new("z-stdlib-env-invalid-inputs")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_z/z_stdlib_env_returns_null_for_invalid_inputs_and_missing_values.stdout.txt",
        );
}

#[test]
fn z_stdlib_env_or_uses_defaults_only_for_null_paths() {
