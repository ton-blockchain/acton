//! Reserved for agent-co.
//! Prefix: co_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_co/**
//! Agent-owned tests for net.getDeployedCode transition coverage.
...
#[test]
fn co_stdlib_get_deployed_code_transitions_from_null_to_non_null_in_project_builder() {
    let source = format!(
        r#"
{PROJECT_IMPORTS}
...
"#
    ...
    ProjectBuilder::new("co-stdlib-get-deployed-code-project-builder")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_co/co_stdlib_get_deployed_code_transitions_from_null_to_non_null_in_project_builder.stdout.txt",
        );
}

#[test]
fn co_stdlib_get_deployed_code_transitions_from_null_to_non_null_in_fixture_project() {
...
"#;
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_co/co_stdlib_get_deployed_code_transitions_from_null_to_non_null_in_fixture_project.stdout.txt",
        );
}
