...
//! - tests/integration/test_std_agent_an_tests.rs
//! - tests/integration/snapshots/test_std_agent_an/**
...
"#,
        "integration/snapshots/test_std_agent_an/an_stdlib_crypto_create_mnemonic_returns_24_words.stdout.txt",
    );
}

#[test]
fn an_stdlib_crypto_to_keypair_is_deterministic_for_same_mnemonic() {
    run_crypto_case(
...
"#,
        "integration/snapshots/test_std_agent_an/an_stdlib_crypto_to_keypair_is_deterministic_for_same_mnemonic.stdout.txt",
    );
}

#[test]
fn an_stdlib_crypto_sign_matches_raw_sign_and_verifies() {
    run_crypto_case(
...
"#,
        "integration/snapshots/test_std_agent_an/an_stdlib_crypto_sign_matches_raw_sign_and_verifies.stdout.txt",
    );
}

#[test]
fn an_stdlib_crypto_raw_sign_is_deterministic_and_hash_sensitive() {
    run_crypto_case(
...
"#,
        "integration/snapshots/test_std_agent_an/an_stdlib_crypto_raw_sign_is_deterministic_and_hash_sensitive.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test_std_agent_an/an_stdlib_crypto_fast_random_bytes_seeded_are_deterministic.stdout.txt",
    );
}

#[test]
fn an_stdlib_crypto_fast_random_bytes_rejects_128_bytes() {
    run_crypto_case(
...
#[test]
fn an_stdlib_crypto_secure_random_bytes_supports_1_and_127() {
    run_crypto_case(
...
"#,
        "integration/snapshots/test_std_agent_an/an_stdlib_crypto_secure_random_bytes_supports_1_and_127.stdout.txt",
    );
}

#[test]
fn an_stdlib_crypto_secure_random_bytes_rejects_128_bytes() {
    run_crypto_case(
...
"#,
        "integration/snapshots/test_std_agent_an/an_stdlib_crypto_secure_random_bytes_rejects_128_bytes.stdout.txt",
    );
}
