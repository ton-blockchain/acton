//! Reserved integration test module for subagent AI.
//!
//! Ownership boundary for agent AI:
//! - tests/integration/test_std_agent_ai_tests.rs
//! - tests/integration/snapshots/test_std_agent_ai/**
//! - tests/integration/testdata/test_std_agent_ai/**
//! - tests/support/test_std_agent_ai/** (optional)
//!
...
#[test]
fn ai_stdlib_config_raw_param_roundtrip_for_global_version_cell() {
...
"#,
        "integration/snapshots/test_std_agent_ai/ai_stdlib_config_raw_param_roundtrip_for_global_version_cell.stdout.txt",
    );
}

#[test]
fn ai_stdlib_config_set_config_rejects_invalid_global_version_cell() {
    run_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ai/ai_stdlib_config_set_config_rejects_invalid_global_version_cell.stdout.txt",
    );
}

#[test]
fn ai_stdlib_config_storage_prices_roundtrip_updates_initial_entry() {
    run_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ai/ai_stdlib_config_storage_prices_roundtrip_updates_initial_entry.stdout.txt",
    );
}

#[test]
fn ai_stdlib_config_gas_prices_update_basechain_and_masterchain_independently() {
    run_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ai/ai_stdlib_config_gas_prices_update_basechain_and_masterchain_independently.stdout.txt",
    );
}

#[test]
fn ai_stdlib_config_msg_forward_prices_update_changes_forward_fee_opcode_result() {
    run_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ai/ai_stdlib_config_msg_forward_prices_update_changes_forward_fee_opcode_result.stdout.txt",
    );
}

#[test]
fn ai_stdlib_config_precompiled_contracts_roundtrip_and_duplicate_insert_guard() {
    run_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ai/ai_stdlib_config_precompiled_contracts_roundtrip_and_duplicate_insert_guard.stdout.txt",
    );
}

#[test]
fn ai_stdlib_config_gas_price_change_affects_run_get_method_result() {
...
"#,
        "integration/snapshots/test_std_agent_ai/ai_stdlib_config_gas_price_change_affects_run_get_method_result.stdout.txt",
    );
}
