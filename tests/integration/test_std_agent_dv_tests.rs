...
//! - tests/integration/test_std_agent_dv_tests.rs
//! - tests/integration/snapshots/test_std_agent_dv/**
...
#[test]
fn dv_stdlib_vm_register_library_is_idempotent_under_repeated_same_cell_registration() {
...
"#,
        "integration/snapshots/test_std_agent_dv/dv_stdlib_vm_register_library_is_idempotent_under_repeated_same_cell_registration.stdout.txt",
    );
}
