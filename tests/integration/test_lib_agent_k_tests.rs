...
#[test]
fn k_lib_api_comparison_matchers_pass() {
    ProjectBuilder::new("k-lib-api-comparison-pass")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_lib_agent_k/k_lib_api_comparison_matchers_pass.stdout.txt",
        );
}

#[test]
fn k_lib_api_comparison_matchers_fail() {
    ProjectBuilder::new("k-lib-api-comparison-fail")
        ...
        .assert_failed(4)
        .assert_snapshot_matches(
            "integration/snapshots/test_lib_agent_k/k_lib_api_comparison_matchers_fail.stdout.txt",
        );
}

#[test]
fn k_lib_api_approx_matchers_pass() {
    ProjectBuilder::new("k-lib-api-approx-pass")
        ...
        .assert_passed(4)
        .assert_snapshot_matches(
            "integration/snapshots/test_lib_agent_k/k_lib_api_approx_matchers_pass.stdout.txt",
        );
}

#[test]
fn k_lib_api_approx_matchers_fail() {
    ProjectBuilder::new("k-lib-api-approx-fail")
        ...
        .assert_failed(3)
        .assert_snapshot_matches(
            "integration/snapshots/test_lib_agent_k/k_lib_api_approx_matchers_fail.stdout.txt",
        );
}
