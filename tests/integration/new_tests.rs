...
fn create_project_and_check_wrappers(
    ...
    create_project_and_check_wrappers_inner(
        test_name,
        template,
        false,
        false,
        contracts_and_wrappers,
    );
}
...
fn create_app_project_and_check_wrappers_with_build(
    test_name: &str,
    template: &str,
    contracts_and_wrappers: &[(&str, &str)],
) {
...
fn test_new_jetton_app_template_wrappers_match_autogenerated() {
    create_app_project_and_check_wrappers_with_build(
