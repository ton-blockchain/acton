//! Reserved integration test module for subagent CH.
//!
//! Ownership boundary for agent CH:
//! - tests/integration/test_std_agent_ch_tests.rs
//! - tests/integration/snapshots/test_std_agent_ch/**
//! - tests/integration/testdata/test_std_agent_ch/**
//! - tests/support/test_std_agent_ch/** (optional)
//!
...
#[test]
fn ch_stdlib_ext_message_relaxed_load_body_returns_left_value() {
...
"#,
        "integration/snapshots/test_std_agent_ch/ch_stdlib_ext_message_relaxed_load_body_returns_left_value.stdout.txt",
    );
}

#[test]
fn ch_stdlib_ext_message_relaxed_load_body_loads_right_cell_value() {
    run_ext_message_case(
...
"#,
        "integration/snapshots/test_std_agent_ch/ch_stdlib_ext_message_relaxed_load_body_loads_right_cell_value.stdout.txt",
    );
}
