...
//! - tests/integration/test_std_agent_du_tests.rs
//! - tests/integration/snapshots/test_std_agent_du/**
...
#[test]
fn du_stdlib_precompiled_add_contract_gas_duplicate_hash_does_not_overwrite_original_entry() {
...
"#,
        "integration/snapshots/test_std_agent_du/du_stdlib_precompiled_add_contract_gas_duplicate_hash_does_not_overwrite_original_entry.stdout.txt",
    );
}
