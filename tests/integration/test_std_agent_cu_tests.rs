//! Reserved integration test module for subagent CU.
//!
//! Ownership boundary for agent CU:
//! - tests/integration/test_std_agent_cu_tests.rs
//! - tests/integration/snapshots/test_std_agent_cu/**
//! - tests/integration/testdata/test_std_agent_cu/**
//! - tests/support/test_std_agent_cu/** (optional)
//!
...
fn run_cu_network_success(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn cu_stdlib_out_messages_at_cell_and_at_match_for_each_index_project_builder() {
    run_cu_network_success(
...
"#,
        "integration/snapshots/test_std_agent_cu/cu_stdlib_out_messages_at_cell_and_at_match_for_each_index_project_builder.stdout.txt",
    );
}

#[test]
fn cu_stdlib_out_messages_at_cell_and_at_match_for_same_index_fixture_project() {
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_cu/cu_stdlib_out_messages_at_cell_and_at_match_for_same_index_fixture_project.stdout.txt",
        );
}
