...
//! - tests/integration/test_std_agent_cc_tests.rs
//! - tests/integration/snapshots/test_std_agent_cc/**
...
#[test]
fn cc_stdlib_outlist_to_be_empty_passes_for_empty_out_actions() {
    run_outlist_success(
...
"#,
        "integration/snapshots/test_std_agent_cc/cc_stdlib_outlist_to_be_empty_passes_for_empty_out_actions.stdout.txt",
    );
}

#[test]
fn cc_stdlib_outlist_to_be_empty_fails_for_non_empty_out_actions() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_cc/cc_stdlib_outlist_to_be_empty_fails_for_non_empty_out_actions.stdout.txt",
        );
}
