...
//! - tests/integration/test_std_agent_u_tests.rs
//! - tests/integration/snapshots/test_std_agent_u/**
...
#[test]
fn u_stdlib_prompts_return_deterministic_fallbacks_in_non_interactive_runner() {
    ProjectBuilder::new("u-stdlib-prompts-deterministic-fallbacks")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_u/u_stdlib_prompts_return_deterministic_fallbacks_in_non_interactive_runner.stdout.txt",
        );
}

#[test]
fn u_stdlib_confirm_default_true_is_ignored_in_non_interactive_mode_bug() {
