...
//! - tests/integration/test_std_agent_bx_tests.rs
//! - tests/integration/snapshots/test_std_agent_bx/**
...
#[test]
fn bx_stdlib_expect_nan_matchers_accept_nan_and_non_nan_values() {
    let source = format!(
        r#"{EXPECT_IMPORTS}
...
"#
    ...
    run_bx_expect_suite("bx-stdlib-expect-nan-pass", &source)
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_bx/bx_stdlib_expect_nan_matchers_accept_nan_and_non_nan_values.stdout.txt",
        );
}

#[test]
fn bx_stdlib_expect_nan_matchers_report_mismatch_for_nan_and_non_nan_edges() {
    let source = format!(
        r#"{EXPECT_IMPORTS}
...
"#
    ...
    run_bx_expect_suite("bx-stdlib-expect-nan-fail", &source)
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_bx/bx_stdlib_expect_nan_matchers_report_mismatch_for_nan_and_non_nan_edges.stdout.txt",
        );
}
