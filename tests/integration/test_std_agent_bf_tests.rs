//! Reserved integration test module for subagent BF.
//!
//! Ownership boundary for agent BF:
//! - tests/integration/test_std_agent_bf_tests.rs
//! - tests/integration/snapshots/test_std_agent_bf/**
//! - tests/integration/testdata/test_std_agent_bf/**
//! - tests/support/test_std_agent_bf/** (optional)
//!
...
fn run_bf_wallet_success(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn bf_stdlib_wallet_matches_treasury_address_without_broadcast() {
    run_bf_wallet_success(
...
"#,
        "integration/snapshots/test_std_agent_bf/bf_stdlib_wallet_matches_treasury_address_without_broadcast.stdout.txt",
    );
}

#[test]
fn bf_stdlib_wallet_unknown_name_uses_treasury_and_sends_in_non_broadcast_mode() {
    run_bf_wallet_success(
...
"#,
        "integration/snapshots/test_std_agent_bf/bf_stdlib_wallet_unknown_name_uses_treasury_and_sends_in_non_broadcast_mode.stdout.txt",
    );
}
