//! Reserved integration test module for subagent AE.
//!
//! Ownership boundary for agent AE:
//! - tests/integration/test_std_agent_ae_tests.rs
//! - tests/integration/snapshots/test_std_agent_ae/**
//! - tests/integration/testdata/test_std_agent_ae/**
//! - tests/support/test_std_agent_ae/** (optional)
//!
...
#[test]
fn ae_stdlib_to_have_successful_tx_matches_success_and_opcode_filters() {
    run_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ae/ae_stdlib_to_have_successful_tx_matches_success_and_opcode_filters.stdout.txt",
    );
}

#[test]
fn ae_stdlib_to_have_failed_tx_matches_compute_exit_code_filter() {
    run_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ae/ae_stdlib_to_have_failed_tx_matches_compute_exit_code_filter.stdout.txt",
    );
}

#[test]
fn ae_stdlib_to_have_tx_matches_action_exit_code_filter() {
    run_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ae/ae_stdlib_to_have_tx_matches_action_exit_code_filter.stdout.txt",
    );
}

#[test]
fn ae_stdlib_to_have_bounced_tx_matches_bounced_opcode_and_exit_code_filters() {
    run_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ae/ae_stdlib_to_have_bounced_tx_matches_bounced_opcode_and_exit_code_filters.stdout.txt",
    );
}

#[test]
fn ae_stdlib_to_emit_external_message_matches_emitted_type() {
    run_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ae/ae_stdlib_to_emit_external_message_matches_emitted_type.stdout.txt",
    );
}

#[test]
fn ae_stdlib_to_emit_external_message_fails_for_missing_external_output() {
    run_failure_case(
...
"#,
        "integration/snapshots/test_std_agent_ae/ae_stdlib_to_emit_external_message_fails_for_missing_external_output.stdout.txt",
    );
}

#[test]
fn ae_stdlib_to_have_failed_tx_requires_non_null_exit_code_param() {
    run_failure_case(
...
"#,
        "integration/snapshots/test_std_agent_ae/ae_stdlib_to_have_failed_tx_requires_non_null_exit_code_param.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test_std_agent_ae/ae_stdlib_to_not_have_tx_with_deploy_false_is_ignored_bug.stdout.txt",
    );
}
