...
//! - tests/integration/test_std_agent_eo_tests.rs
//! - tests/integration/snapshots/test_std_agent_eo/**
...
"#,
        "integration/snapshots/test_std_agent_eo/eo_stdlib_transaction_varuint_unpack_from_slice_supports_canonical_boundary_values.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test_std_agent_eo/eo_stdlib_transaction_varuint7_pack_to_builder_roundtrip_boundary_bug.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test_std_agent_eo/eo_stdlib_transaction_varuint3_pack_to_builder_roundtrip_boundary_bug.stdout.txt",
    );
}
