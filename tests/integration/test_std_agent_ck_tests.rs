...
//! - tests/integration/test_std_agent_ck_tests.rs
//! - tests/integration/snapshots/test_std_agent_ck/**
...
#[test]
fn ck_stdlib_transaction_get_action_fee_tick_and_tock_match_ord_action_fee() {
    run_ck_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ck/ck_stdlib_transaction_get_action_fee_tick_and_tock_match_ord_action_fee.stdout.txt",
    );
}

#[test]
fn ck_stdlib_transaction_get_action_fee_tick_tock_without_action_returns_none() {
    run_ck_success_case(
...
"#,
        "integration/snapshots/test_std_agent_ck/ck_stdlib_transaction_get_action_fee_tick_tock_without_action_returns_none.stdout.txt",
    );
}
