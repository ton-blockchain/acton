//! Reserved integration test module for subagent DA.
//!
//! Ownership boundary for agent DA:
//! - tests/integration/test_std_agent_da_tests.rs
//! - tests/integration/snapshots/test_std_agent_da/**
//! - tests/integration/testdata/test_std_agent_da/**
//! - tests/support/test_std_agent_da/** (optional)
//!
...
fn run_da_transaction_success(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn da_stdlib_transaction_load_in_msg_decodes_typed_payload_and_matches_inbound_opcode() {
    run_da_transaction_success(
...
"#,
        "integration/snapshots/test_std_agent_da/da_stdlib_transaction_load_in_msg_decodes_typed_payload_and_matches_inbound_opcode.stdout.txt",
    );
}

#[test]
fn da_stdlib_transaction_load_in_msg_in_fixture_project_matches_inbound_opcode() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_da/da_stdlib_transaction_load_in_msg_in_fixture_project_matches_inbound_opcode.stdout.txt",
        );
}
