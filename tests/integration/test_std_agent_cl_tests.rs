...
//! - tests/integration/test_std_agent_cl_tests.rs
//! - tests/integration/snapshots/test_std_agent_cl/**
...
"#,
        "integration/snapshots/test_std_agent_cl/cl_stdlib_set_config_param_keeps_neighbor_slots_consistent.stdout.txt",
    );
}

#[test]
fn cl_stdlib_set_config_param_slot_three_updates_blockchain_now_and_c7() {
    run_cl_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_cl/cl_stdlib_set_config_param_slot_three_updates_blockchain_now_and_c7.stdout.txt",
    );
}
