//! Reserved for agent-dm.
//! Prefix: dm_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_dm/**
//! Agent-owned tests for Config.setParamRaw/getParamRaw behavior.
...
fn run_dm_config_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn dm_stdlib_config_set_param_raw_get_param_raw_roundtrip_preserves_cell_shape() {
    run_dm_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dm/dm_stdlib_config_set_param_raw_get_param_raw_roundtrip_preserves_cell_shape.stdout.txt",
    );
}

#[test]
fn dm_stdlib_config_set_param_raw_overwrite_keeps_neighbor_slot_unchanged() {
    run_dm_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dm/dm_stdlib_config_set_param_raw_overwrite_keeps_neighbor_slot_unchanged.stdout.txt",
    );
}
