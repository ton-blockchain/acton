...
//! - tests/integration/test_std_agent_aj_tests.rs
//! - tests/integration/snapshots/test_std_agent_aj/**
...
#[test]
fn aj_stdlib_set_time_and_logical_time_update_c7_slots() {
...
"#,
        "integration/snapshots/test_std_agent_aj/aj_stdlib_set_time_and_logical_time_update_c7_slots.stdout.txt",
    );
}

#[test]
fn aj_stdlib_set_original_balance_updates_balance_tuple_with_and_without_extra_dict() {
    run_aj_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_aj/aj_stdlib_set_original_balance_updates_balance_tuple_with_and_without_extra_dict.stdout.txt",
    );
}

#[test]
fn aj_stdlib_set_config_root_dict_replaces_c7_root_config_slot() {
    run_aj_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_aj/aj_stdlib_set_config_root_dict_replaces_c7_root_config_slot.stdout.txt",
    );
}

#[test]
fn aj_stdlib_set_and_get_config_unpacked_round_trip_slot_14() {
    run_aj_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_aj/aj_stdlib_set_and_get_config_unpacked_round_trip_slot_14.stdout.txt",
    );
}

#[test]
fn aj_stdlib_register_library_accepts_code_and_empty_cells() {
    run_aj_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_aj/aj_stdlib_register_library_accepts_code_and_empty_cells.stdout.txt",
    );
}

#[test]
fn aj_stdlib_convert_address_supports_raw_and_user_friendly_forms() {
    run_aj_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_aj/aj_stdlib_convert_address_supports_raw_and_user_friendly_forms.stdout.txt",
    );
}

#[test]
fn aj_stdlib_convert_address_reports_invalid_input() {
...
"#,
        ...
        "integration/snapshots/test_std_agent_aj/aj_stdlib_convert_address_reports_invalid_input.stdout.txt",
    );
}
...
#[test]
fn aj_stdlib_cell_from_hex_decodes_valid_boc_hex() {
    run_aj_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_aj/aj_stdlib_cell_from_hex_decodes_valid_boc_hex.stdout.txt",
    );
}

#[test]
fn aj_stdlib_cell_from_hex_reports_invalid_hex() {
    run_aj_vm_failure_case(
...
"#,
        ...
        "integration/snapshots/test_std_agent_aj/aj_stdlib_cell_from_hex_reports_invalid_hex.stdout.txt",
    );
}
