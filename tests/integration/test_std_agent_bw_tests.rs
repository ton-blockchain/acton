//! Reserved integration test module for subagent BW.
//!
//! Ownership boundary for agent BW:
//! - tests/integration/test_std_agent_bw_tests.rs
//! - tests/integration/snapshots/test_std_agent_bw/**
//! - tests/integration/testdata/test_std_agent_bw/**
//! - tests/support/test_std_agent_bw/** (optional)
//!
...
fn run_bw_wallet_missing_failure(
    project_name: &str,
    test_body: &str,
    snapshot_path: &str,
...
#[test]
fn bw_stdlib_wallet_missing_in_broadcast_without_wallets_config_reports_setup_instructions() {
    run_bw_wallet_missing_failure(
...
"#,
        "integration/snapshots/test_std_agent_bw/bw_stdlib_wallet_missing_in_broadcast_without_wallets_config_reports_setup_instructions.stdout.txt",
        None,
    );
}

#[test]
fn bw_stdlib_wallet_missing_in_broadcast_with_wallets_config_lists_available_wallets() {
    run_bw_wallet_missing_failure(
...
"#,
        "integration/snapshots/test_std_agent_bw/bw_stdlib_wallet_missing_in_broadcast_with_wallets_config_lists_available_wallets.stdout.txt",
