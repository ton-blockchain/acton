//! Reserved integration test module for subagent EH.
//!
//! Ownership boundary for agent EH:
//! - tests/integration/test_std_agent_eh_tests.rs
//! - tests/integration/snapshots/test_std_agent_eh/**
//! - tests/integration/testdata/test_std_agent_eh/**
//! - tests/support/test_std_agent_eh/** (optional)
//!
...
#[test]
fn eh_stdlib_env_or_address_falls_back_for_invalid_present_and_uses_valid_present_value() {
    ProjectBuilder::new("eh-stdlib-env-or-address-fallback-vs-valid-precedence")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_eh/eh_stdlib_env_or_address_falls_back_for_invalid_present_and_uses_valid_present_value.stdout.txt",
        );
}

#[test]
fn eh_stdlib_env_or_cell_falls_back_for_invalid_present_and_uses_valid_present_value() {
    ...
    ProjectBuilder::new("eh-stdlib-env-or-cell-fallback-vs-valid-precedence")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_eh/eh_stdlib_env_or_cell_falls_back_for_invalid_present_and_uses_valid_present_value.stdout.txt",
        );
}
