...
//! - tests/integration/test_std_agent_ds_tests.rs
//! - tests/integration/snapshots/test_std_agent_ds/**
...
#[test]
fn ds_stdlib_config_set_gas_prices_sequential_chain_updates_remain_isolated() {
...
"#,
        "integration/snapshots/test_std_agent_ds/ds_stdlib_config_set_gas_prices_sequential_chain_updates_remain_isolated.stdout.txt",
    );
}
