...
//! - tests/integration/test_std_agent_am_tests.rs
//! - tests/integration/snapshots/test_std_agent_am/**
...
"#,
        "integration/snapshots/test_std_agent_am/am_stdlib_transaction_load_body_and_load_in_msg_extract_typed_payload_and_endpoints.stdout.txt",
    );
}

#[test]
fn am_stdlib_transaction_load_body_reports_exit_code63_for_mismatched_message_type() {
    run_am_success_case(
...
"#,
        "integration/snapshots/test_std_agent_am/am_stdlib_transaction_load_body_reports_exit_code63_for_mismatched_message_type.stdout.txt",
    );
}

#[test]
fn am_stdlib_transaction_load_in_msg_reports_exit_code63_for_mismatched_message_type() {
    run_am_success_case(
...
"#,
        "integration/snapshots/test_std_agent_am/am_stdlib_transaction_load_in_msg_reports_exit_code63_for_mismatched_message_type.stdout.txt",
    );
}

#[test]
fn am_stdlib_transaction_get_used_gas_matches_send_result_for_root_and_child_transactions() {
    run_am_success_case(
...
"#,
        "integration/snapshots/test_std_agent_am/am_stdlib_transaction_get_used_gas_matches_send_result_for_root_and_child_transactions.stdout.txt",
    );
}

#[test]
fn am_stdlib_transaction_get_used_gas_reports_skipped_compute_phase_for_undeployed_destination() {
    run_am_success_case(
...
"#,
        "integration/snapshots/test_std_agent_am/am_stdlib_transaction_get_used_gas_reports_skipped_compute_phase_for_undeployed_destination.stdout.txt",
    );
}

#[test]
fn am_stdlib_transaction_get_action_fee_matches_transaction_description_and_none_branch() {
    run_am_success_case(
...
"#,
        "integration/snapshots/test_std_agent_am/am_stdlib_transaction_get_action_fee_matches_transaction_description_and_none_branch.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test_std_agent_am/am_stdlib_transaction_get_account_address_defaults_to_basechain_and_supports_masterchain_override.stdout.txt",
    );
}
