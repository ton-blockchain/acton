...
//! - tests/integration/test_std_agent_y_tests.rs
//! - tests/integration/snapshots/test_std_agent_y/**
...
"#,
        "integration/snapshots/test_std_agent_y/y_stdlib_format1_and_format2_support_plain_hex_and_ton_specifiers.stdout.txt",
    );
}

#[test]
fn y_stdlib_format3_and_format4_support_mixed_plain_hex_and_ton() {
    run_fmt_success(
...
"#,
        "integration/snapshots/test_std_agent_y/y_stdlib_format3_and_format4_support_mixed_plain_hex_and_ton.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test_std_agent_y/y_stdlib_format5_should_respect_placeholder_order_for_plain_hex_and_ton_bug.stdout.txt",
    );
}
