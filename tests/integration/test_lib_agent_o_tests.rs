//! Reserved integration test module for subagent O.
//!
//! Ownership boundary for agent O:
//! - tests/integration/test_lib_agent_o_tests.rs
//! - tests/integration/snapshots/test_lib_agent_o/**
//! - tests/integration/testdata/test_lib_agent_o/**
//! - tests/support/test_lib_agent_o/** (optional)
//!
...
#[test]
fn o_lib_api_send_external_collects_external_messages_with_deterministic_order() {
    run_success_case(
...
#[test]
fn o_lib_api_create_external_message_accepts_explicit_external_src() {
    run_success_case(
...
#[test]
fn o_lib_api_send_external_is_repeatable_for_same_contract() {
    run_success_case(
...
#[test]
fn o_lib_api_create_external_message_rejects_internal_src() {
    run_failure_case(
...
#[test]
fn o_lib_api_find_external_out_message_has_generic_compilation_bug() {
    run_success_case(
