...
//! - tests/integration/test_std_agent_cn_tests.rs
//! - tests/integration/snapshots/test_std_agent_cn/**
...
"#,
        "integration/snapshots/test_std_agent_cn/cn_stdlib_set_c5_roundtrip_restores_single_and_double_action_out_lists.stdout.txt",
    );
}
