//! Reserved integration test module for subagent DO.
//!
//! Ownership boundary for agent DO:
//! - tests/integration/test_std_agent_do_tests.rs
//! - tests/integration/snapshots/test_std_agent_do/**
//! - tests/integration/testdata/test_std_agent_do/**
//! - tests/support/test_std_agent_do/** (optional)
//!
...
fn run_do_config_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn do_stdlib_config_global_version_roundtrip_supports_zero_values() {
    run_do_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_do/do_stdlib_config_global_version_roundtrip_supports_zero_values.stdout.txt",
    );
}

#[test]
fn do_stdlib_config_global_version_roundtrip_supports_non_zero_values() {
    run_do_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_do/do_stdlib_config_global_version_roundtrip_supports_non_zero_values.stdout.txt",
    );
}
