...
//! - tests/integration/test_std_agent_cq_tests.rs
//! - tests/integration/snapshots/test_std_agent_cq/**
...
#[test]
fn cq_stdlib_register_address_duplicate_symbolic_name_rebind_visibility_in_output() {
    run_cq_network_case(
...
"#,
        "integration/snapshots/test_std_agent_cq/cq_stdlib_register_address_duplicate_symbolic_name_rebind_visibility_in_output.stdout.txt",
    );
}
