//! Reserved integration test module for subagent CG.
//!
//! Ownership boundary for agent CG:
//! - tests/integration/test_std_agent_cg_tests.rs
//! - tests/integration/snapshots/test_std_agent_cg/**
//! - tests/integration/testdata/test_std_agent_cg/**
//! - tests/support/test_std_agent_cg/** (optional)
//!
...
#[test]
fn cg_stdlib_to_have_successful_deploy_rejects_non_deploy_success_transaction() {
...
"#,
        "integration/snapshots/test_std_agent_cg/cg_stdlib_to_have_successful_deploy_rejects_non_deploy_success_transaction.stdout.txt",
    );
}

#[test]
fn cg_stdlib_to_have_successful_deploy_failure_format_includes_expected_search_params() {
    run_deploy_expect_failure(
...
"#,
        "integration/snapshots/test_std_agent_cg/cg_stdlib_to_have_successful_deploy_failure_format_includes_expected_search_params.stdout.txt",
    );
}
