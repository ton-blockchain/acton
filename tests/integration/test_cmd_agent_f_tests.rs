//! Reserved integration test module for subagent F.
//!
//! Ownership boundary for agent F:
//! - tests/integration/test_cmd_agent_f_tests.rs
//! - tests/integration/snapshots/test_cmd_agent_f/**
//! - tests/integration/testdata/test_cmd_agent_f/**
//! - tests/support/test_cmd_agent_f/** (optional)
//!
...
#[test]
fn f_test_cmd_ui_creates_default_trace_dir_and_runs_tests_before_bind_failure() {
    ...
    project
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_f/f_test_cmd_ui_creates_default_trace_dir_and_runs_tests_before_bind_failure.stdout.txt",
        );
}

#[test]
fn f_test_cmd_ui_save_test_trace_writes_to_custom_directory() {
    ...
    project
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_f/f_test_cmd_ui_save_test_trace_writes_to_custom_directory.stdout.txt",
        );
...
#[test]
fn f_test_cmd_ui_trace_files_are_created_only_for_executed_tests() {
...
#[test]
fn f_test_cmd_ui_works_with_dot_reporter_without_console_summary() {
    ...
    project
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_f/f_test_cmd_ui_works_with_dot_reporter_without_console_summary.stdout.txt",
        );
}

#[test]
fn f_test_cmd_ui_filter_limits_trace_generation_to_selected_tests() {
