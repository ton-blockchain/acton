...
#[test]
#[named]
fn check_lint_sarif_uses_output_format_from_config() {
    let project = ProjectBuilder::new(&format!("check-{}", function_name!()))
        .contract("main", UNUSED_VARIABLE_CONTRACT)
        .with_lint_level("unused-variable", "warn")
...
#[test]
#[named]
fn check_lint_sarif_fix_does_not_apply_with_non_plain_output() {
    let project = ProjectBuilder::new(&format!("check-{}", function_name!()))
        .contract("main", UNUSED_VARIABLE_CONTRACT)
        .with_lint_level("unused-variable", "warn")
        .build();
    ...
    project
        ...
        .arg("--fix")
        .arg("--output-file")
        .arg(".acton/reports/fixed.sarif")
        .run()
        .success()
        .assert_file_contains(".acton/reports/fixed.sarif", "\"level\": \"warning\"")
        .assert_file_contains(
            ".acton/reports/fixed.sarif",
            "\"actonApplicability\": \"auto\"",
        )
