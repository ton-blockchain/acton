//! Reserved integration test module for subagent BD.
//!
//! Ownership boundary for agent BD:
//! - tests/integration/test_std_agent_bd_tests.rs
//! - tests/integration/snapshots/test_std_agent_bd/**
//! - tests/integration/testdata/test_std_agent_bd/**
//! - tests/support/test_std_agent_bd/** (optional)
//!
...
#[test]
fn bd_stdlib_config_set_gas_prices_extended_fields_keep_base_and_masterchain_independent() {
...
"#,
        "integration/snapshots/test_std_agent_bd/bd_stdlib_config_set_gas_prices_extended_fields_keep_base_and_masterchain_independent.stdout.txt",
    );
}

#[test]
fn bd_stdlib_config_set_gas_prices_for_basechain_does_not_change_masterchain_extended_fields() {
    run_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_bd/bd_stdlib_config_set_gas_prices_for_basechain_does_not_change_masterchain_extended_fields.stdout.txt",
    );
}
