//! Reserved integration test module for subagent AB.
//!
//! Ownership boundary for agent AB:
//! - tests/integration/test_std_agent_ab_tests.rs
//! - tests/integration/snapshots/test_std_agent_ab/**
//! - tests/integration/testdata/test_std_agent_ab/**
//! - tests/support/test_std_agent_ab/** (optional)
//!
...
#[test]
fn ab_stdlib_either_left_and_right_encode_expected_tag_bits() {
    run_either_case(
        ...
        "#,
        "integration/snapshots/test_std_agent_ab/ab_stdlib_either_left_and_right_encode_expected_tag_bits.stdout.txt",
    );
}

#[test]
fn ab_stdlib_either_match_routes_left_and_right_variants() {
    run_either_case(
        ...
        "#,
        "integration/snapshots/test_std_agent_ab/ab_stdlib_either_match_routes_left_and_right_variants.stdout.txt",
    );
}
