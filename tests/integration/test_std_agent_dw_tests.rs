//! Reserved for agent-dw.
//! Prefix: dw_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_dw/**
...
fn run_dw_crypto_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn dw_stdlib_crypto_create_mnemonic_returns_24_non_empty_words() {
    run_dw_crypto_case(
...
"#,
        "integration/snapshots/test_std_agent_dw/dw_stdlib_crypto_create_mnemonic_returns_24_non_empty_words.stdout.txt",
    );
}

#[test]
fn dw_stdlib_crypto_create_mnemonic_outputs_are_valid_for_keypair_derivation_in_fixture_project() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_dw/dw_stdlib_crypto_create_mnemonic_outputs_are_valid_for_keypair_derivation_in_fixture_project.stdout.txt",
        );
}
