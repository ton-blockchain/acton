//! Reserved integration test module for subagent AH.
//!
//! Ownership boundary for agent AH:
//! - tests/integration/test_std_agent_ah_tests.rs
//! - tests/integration/snapshots/test_std_agent_ah/**
//! - tests/integration/testdata/test_std_agent_ah/**
//! - tests/support/test_std_agent_ah/** (optional)
//!
...
fn run_ah_stdlib_case(project_name: &str, test_body: &str, snapshot_path: &str, contains: &[&str]) {
...
"#,
        "integration/snapshots/test_std_agent_ah/ah_stdlib_balance_returns_zero_for_unknown_address_then_top_up_updates_balance.stdout.txt",
        &[],
    );
}

#[test]
fn ah_stdlib_top_up_is_additive_for_the_same_address() {
    run_ah_stdlib_case(
...
"#,
        "integration/snapshots/test_std_agent_ah/ah_stdlib_top_up_is_additive_for_the_same_address.stdout.txt",
        &[],
    );
}

#[test]
fn ah_stdlib_set_account_on_fresh_target_preserves_shard_markers() {
    run_ah_stdlib_case(
...
"#,
        "integration/snapshots/test_std_agent_ah/ah_stdlib_set_account_on_fresh_target_preserves_shard_markers.stdout.txt",
        &[],
    );
}
...
"#,
        "integration/snapshots/test_std_agent_ah/ah_stdlib_set_account_preserves_existing_shard_markers_and_balance.stdout.txt",
        &[],
    );
}

#[test]
fn ah_stdlib_set_shard_account_copies_markers_and_balance_between_addresses() {
    run_ah_stdlib_case(
...
"#,
        "integration/snapshots/test_std_agent_ah/ah_stdlib_set_shard_account_copies_markers_and_balance_between_addresses.stdout.txt",
        &[],
    );
}

#[test]
fn ah_stdlib_set_shard_account_null_resets_balance_and_markers() {
    run_ah_stdlib_case(
...
"#,
        "integration/snapshots/test_std_agent_ah/ah_stdlib_set_shard_account_null_resets_balance_and_markers.stdout.txt",
        &[],
    );
}

#[test]
fn ah_stdlib_register_address_name_is_used_in_transaction_output() {
    run_ah_stdlib_case(
...
"#,
        "integration/snapshots/test_std_agent_ah/ah_stdlib_register_address_name_is_used_in_transaction_output.stdout.txt",
        &["ah_registered_target"],
    );
}

#[test]
fn ah_stdlib_register_code_cell_name_is_used_for_auto_deploy_output() {
    run_ah_stdlib_case(
...
"#,
        "integration/snapshots/test_std_agent_ah/ah_stdlib_register_code_cell_name_is_used_for_auto_deploy_output.stdout.txt",
