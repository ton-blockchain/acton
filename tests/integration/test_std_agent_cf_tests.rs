//! Reserved integration test module for subagent CF.
//!
//! Ownership boundary for agent CF:
//! - tests/integration/test_std_agent_cf_tests.rs
//! - tests/integration/snapshots/test_std_agent_cf/**
//! - tests/integration/testdata/test_std_agent_cf/**
//! - tests/support/test_std_agent_cf/** (optional)
//!
...
fn run_cf_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn cf_stdlib_to_consume_less_than_accepts_threshold_above_measured_gas() {
    run_cf_success_case(
...
"#,
        "integration/snapshots/test_std_agent_cf/cf_stdlib_to_consume_less_than_accepts_threshold_above_measured_gas.stdout.txt",
    );
}

#[test]
fn cf_stdlib_to_consume_less_than_fails_on_equal_threshold_boundary() {
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_cf/cf_stdlib_to_consume_less_than_fails_on_equal_threshold_boundary.stdout.txt",
        );
}
