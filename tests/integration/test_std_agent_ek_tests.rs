...
//! - tests/integration/test_std_agent_ek_tests.rs
//! - tests/integration/snapshots/test_std_agent_ek/**
...
#[test]
fn ek_stdlib_assert_equal_passes_for_identical_tuple_values() {
...
"#,
    ...
    ProjectBuilder::new("ek-stdlib-assert-equal-pass-identical-tuple")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_ek/ek_stdlib_assert_equal_passes_for_identical_tuple_values.stdout.txt",
        );
}

#[test]
fn ek_stdlib_assert_equal_reports_actual_and_expected_on_failure() {
    let source = wrap_assert_source(
        r#"
...
"#,
    ...
    ProjectBuilder::new("ek-stdlib-assert-equal-failure-diagnostics")
        ...
        .assert_contains("41")
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_ek/ek_stdlib_assert_equal_reports_actual_and_expected_on_failure.stdout.txt",
        );
}
