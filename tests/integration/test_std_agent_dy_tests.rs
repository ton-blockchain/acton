...
//! - tests/integration/test_std_agent_dy_tests.rs
//! - tests/integration/snapshots/test_std_agent_dy/**
...
#[test]
fn dy_stdlib_crypto_secure_random_bytes_boundaries_1_and_2_have_expected_lengths() {
...
"#,
        "integration/snapshots/test_std_agent_dy/dy_stdlib_crypto_secure_random_bytes_boundaries_1_and_2_have_expected_lengths.stdout.txt",
    );
}

#[test]
fn dy_stdlib_crypto_secure_random_bytes_size_2_keeps_length_across_calls_in_fixture_project() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_dy/dy_stdlib_crypto_secure_random_bytes_size_2_keeps_length_across_calls_in_fixture_project.stdout.txt",
        );
}
