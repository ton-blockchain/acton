//! Reserved integration test module for subagent BV.
//!
//! Ownership boundary for agent BV:
//! - tests/integration/test_std_agent_bv_tests.rs
//! - tests/integration/snapshots/test_std_agent_bv/**
//! - tests/integration/testdata/test_std_agent_bv/**
//! - tests/support/test_std_agent_bv/** (optional)
//!
...
#[test]
fn bv_stdlib_assert_fail_formats_message_and_custom_location_in_output() {
...
"#,
    ...
    ProjectBuilder::new("bv-stdlib-assert-fail-custom-location")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_bv/bv_stdlib_assert_fail_formats_message_and_custom_location_in_output.stdout.txt",
        );
}

#[test]
fn bv_stdlib_assert_fail_honors_expected_exit_code_path_in_fixture_project() {
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_bv/bv_stdlib_assert_fail_honors_expected_exit_code_path_in_fixture_project.stdout.txt",
        );
}
