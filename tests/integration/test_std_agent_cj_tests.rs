...
#[test]
fn cj_stdlib_parse_out_actions_reserve_zero_nanoton_stays_reserve_currency() {
    run_cj_stdlib_success(
...
"#,
        "integration/snapshots/test_std_agent_cj/cj_stdlib_parse_out_actions_reserve_zero_nanoton_stays_reserve_currency.stdout.txt",
    );
}

#[test]
fn cj_stdlib_parse_out_actions_single_set_code_action_is_decoded() {
    run_cj_stdlib_success(
...
"#,
        "integration/snapshots/test_std_agent_cj/cj_stdlib_parse_out_actions_single_set_code_action_is_decoded.stdout.txt",
    );
}

#[test]
fn cj_stdlib_parse_out_actions_single_send_message_action_preserves_mode() {
    run_cj_stdlib_success(
...
"#,
        "integration/snapshots/test_std_agent_cj/cj_stdlib_parse_out_actions_single_send_message_action_preserves_mode.stdout.txt",
    );
}

#[test]
fn cj_stdlib_parse_out_actions_reserve_zero_and_one_preserve_kind_and_amount() {
    run_cj_stdlib_success(
...
"#,
        "integration/snapshots/test_std_agent_cj/cj_stdlib_parse_out_actions_reserve_zero_and_one_preserve_kind_and_amount.stdout.txt",
    );
}

#[test]
fn cj_stdlib_parse_out_actions_mixed_action_chain_preserves_order_and_types() {
    run_cj_stdlib_success(
...
"#,
        "integration/snapshots/test_std_agent_cj/cj_stdlib_parse_out_actions_mixed_action_chain_preserves_order_and_types.stdout.txt",
    );
}
