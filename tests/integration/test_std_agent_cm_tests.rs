//! Reserved integration test module for subagent CM.
//!
//! Ownership boundary for agent CM:
//! - tests/integration/test_std_agent_cm_tests.rs
//! - tests/integration/snapshots/test_std_agent_cm/**
//! - tests/integration/testdata/test_std_agent_cm/**
//! - tests/support/test_std_agent_cm/** (optional)
//!
...
fn run_cm_vm_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn cm_stdlib_vm_set_c7_overwrites_slot_three_without_clobbering_neighbors() {
    run_cm_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_cm/cm_stdlib_vm_set_c7_overwrites_slot_three_without_clobbering_neighbors.stdout.txt",
    );
}

#[test]
fn cm_stdlib_vm_set_c7_repeated_reads_and_writes_preserve_unmodified_slots() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_cm/cm_stdlib_vm_set_c7_repeated_reads_and_writes_preserve_unmodified_slots.stdout.txt",
        );
}
