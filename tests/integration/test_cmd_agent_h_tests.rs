...
//! - tests/integration/test_cmd_agent_h_tests.rs
//! - tests/integration/snapshots/test_cmd_agent_h/**
//! - tests/integration/testdata/test_cmd_agent_h/**
//! - tests/support/test_cmd_agent_h/** (optional)
//!
...
#[test]
fn h_test_cmd_save_test_trace_without_path_uses_default_directory() {
    ...
    output
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_h/h_test_cmd_save_test_trace_without_path_uses_default_directory.stdout.txt",
        )
        ...
        .assert_file_snapshot_matches(
            ...
            "integration/snapshots/test_cmd_agent_h/h_test_cmd_save_test_trace_without_path_uses_default_directory.contract.txt",
        );
...
#[test]
fn h_test_cmd_save_test_trace_with_custom_directory_uses_regular_non_ui_flow() {
    let project = trace_project(
    ...
    output
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_h/h_test_cmd_save_test_trace_with_custom_directory_uses_regular_non_ui_flow.stdout.txt",
        )
...
#[test]
fn h_test_cmd_save_test_trace_creates_trace_per_test_and_single_contract_file() {
    let project = trace_project(
        "h-save-trace-multi",
        r#"
    ...
    output
        .assert_passed(2)
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_h/h_test_cmd_save_test_trace_creates_trace_per_test_and_single_contract_file.stdout.txt",
        )
...
#[test]
fn h_test_cmd_regular_run_without_trace_flag_does_not_create_trace_artifacts() {
    let project = trace_project(
    ...
    output
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_h/h_test_cmd_regular_run_without_trace_flag_does_not_create_trace_artifacts.stdout.txt",
        );
...
#[test]
fn h_test_cmd_save_test_trace_can_be_enabled_after_regular_run() {
    let project = trace_project(
    ...
    regular_output
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_h/h_test_cmd_save_test_trace_can_be_enabled_after_regular_run.regular.stdout.txt",
        );
    ...
    traced_output
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test_cmd_agent_h/h_test_cmd_save_test_trace_can_be_enabled_after_regular_run.trace.stdout.txt",
        )
