...
//! - tests/integration/test_std_agent_al_tests.rs
//! - tests/integration/snapshots/test_std_agent_al/**
...
"#,
        "integration/snapshots/test_std_agent_al/al_stdlib_out_actions_list_traversal_preserves_reverse_order_and_kinds.stdout.txt",
    );
}

#[test]
fn al_stdlib_parse_out_actions_from_raw_c5_matches_vm_out_actions() {
    run_al_stdlib_success(
...
"#,
        "integration/snapshots/test_std_agent_al/al_stdlib_parse_out_actions_from_raw_c5_matches_vm_out_actions.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test_std_agent_al/al_stdlib_get_send_message_at_returns_null_for_non_send_entries.stdout.txt",
    );
}

#[test]
fn al_stdlib_get_send_message_body_at_reads_inline_body_left_branch() {
    run_al_stdlib_success(
...
"#,
        "integration/snapshots/test_std_agent_al/al_stdlib_get_send_message_body_at_reads_inline_body_left_branch.stdout.txt",
    );
}

#[test]
fn al_stdlib_get_send_message_body_at_reads_ref_body_right_branch() {
    run_al_stdlib_success(
...
"#,
        "integration/snapshots/test_std_agent_al/al_stdlib_get_send_message_body_at_reads_ref_body_right_branch.stdout.txt",
    );
}
...
#[test]
fn al_stdlib_out_message_out_actions_helper_returns_send_action_with_mode_and_body() {
    run_al_stdlib_success(
