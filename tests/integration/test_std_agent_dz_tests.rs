//! Reserved integration test module for subagent DZ.
//!
//! Ownership boundary for agent DZ:
//! - tests/integration/test_std_agent_dz_tests.rs
//! - tests/integration/snapshots/test_std_agent_dz/**
//! - tests/integration/testdata/test_std_agent_dz/**
//! - tests/support/test_std_agent_dz/** (optional)
//!
...
fn run_dz_crypto_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn dz_stdlib_crypto_sign_is_deterministic_for_same_key_and_cell() {
    run_dz_crypto_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dz/dz_stdlib_crypto_sign_is_deterministic_for_same_key_and_cell.stdout.txt",
    );
}

#[test]
fn dz_stdlib_crypto_sign_has_512bit_slice_shape_and_matches_raw_sign_in_fixture_project() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_dz/dz_stdlib_crypto_sign_has_512bit_slice_shape_and_matches_raw_sign_in_fixture_project.stdout.txt",
        );
}
