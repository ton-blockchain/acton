...
//! - tests/integration/test_std_agent_dc_tests.rs
//! - tests/integration/snapshots/test_std_agent_dc/**
...
"#,
        "integration/snapshots/test_std_agent_dc/dc_stdlib_transaction_get_account_address_defaults_to_basechain_and_masterchain_override_changes_only_workchain.stdout.txt",
    );
}

#[test]
fn dc_stdlib_transaction_get_account_address_masterchain_override_is_stable_in_fixture_project() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_dc/dc_stdlib_transaction_get_account_address_masterchain_override_is_stable_in_fixture_project.stdout.txt",
        );
}
