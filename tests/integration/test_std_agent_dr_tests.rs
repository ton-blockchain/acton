//! Reserved integration test module for subagent DR.
//!
//! Ownership boundary for agent DR:
//! - tests/integration/test_std_agent_dr_tests.rs
//! - tests/integration/snapshots/test_std_agent_dr/**
//! - tests/integration/testdata/test_std_agent_dr/**
//! - tests/support/test_std_agent_dr/** (optional)
//!
...
fn run_dr_config_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn dr_stdlib_config_storage_prices_roundtrip_preserves_multiple_timestamp_entries() {
    run_dr_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dr/dr_stdlib_config_storage_prices_roundtrip_preserves_multiple_timestamp_entries.stdout.txt",
    );
}

#[test]
fn dr_stdlib_config_storage_prices_roundtrip_replaces_old_dictionary_entries_on_second_write() {
    run_dr_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dr/dr_stdlib_config_storage_prices_roundtrip_replaces_old_dictionary_entries_on_second_write.stdout.txt",
    );
}
