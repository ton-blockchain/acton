//! Reserved integration test module for subagent EG.
//!
//! Ownership boundary for agent EG:
//! - tests/integration/test_std_agent_eg_tests.rs
//! - tests/integration/snapshots/test_std_agent_eg/**
//! - tests/integration/testdata/test_std_agent_eg/**
//! - tests/support/test_std_agent_eg/** (optional)
//!
...
#[test]
fn eg_stdlib_assert_equal_decimal_does_not_round_half_up_boundaries() {
...
"#,
    ...
    ProjectBuilder::new("eg-stdlib-assert-equal-decimal-no-round-half-up")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_eg/eg_stdlib_assert_equal_decimal_does_not_round_half_up_boundaries.stdout.txt",
        );
}

#[test]
fn eg_stdlib_assert_equal_decimal_formats_negative_small_values_with_leading_zero() {
    let source = wrap_assert_source(
        r#"
...
"#,
    ...
    ProjectBuilder::new("eg-stdlib-assert-equal-decimal-negative-leading-zero")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_eg/eg_stdlib_assert_equal_decimal_formats_negative_small_values_with_leading_zero.stdout.txt",
        );
}
