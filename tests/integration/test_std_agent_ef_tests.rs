//! Reserved integration test module for subagent EF.
//!
//! Ownership boundary for agent EF:
//! - tests/integration/test_std_agent_ef_tests.rs
//! - tests/integration/snapshots/test_std_agent_ef/**
//! - tests/integration/testdata/test_std_agent_ef/**
//! - tests/support/test_std_agent_ef/** (optional)
//!
...
#[test]
fn ef_stdlib_expect_to_equal_decimal_accepts_zero_and_high_decimals_when_values_match() {
...
"#,
    ...
    ProjectBuilder::new("ef-stdlib-decimal-equality-zero-high-precision")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_ef/ef_stdlib_expect_to_equal_decimal_accepts_zero_and_high_decimals_when_values_match.stdout.txt",
        );
}

#[test]
fn ef_stdlib_expect_to_equal_decimal_formats_zero_and_high_decimal_failures() {
    let source = wrap_expect_source(
        r#"
...
"#,
    ...
    ProjectBuilder::new("ef-stdlib-decimal-failure-format-zero-high")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_ef/ef_stdlib_expect_to_equal_decimal_formats_zero_and_high_decimal_failures.stdout.txt",
        );
}
