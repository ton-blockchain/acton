//! Reserved integration test module for subagent BB.
//!
//! Ownership boundary for agent BB:
//! - tests/integration/test_std_agent_bb_tests.rs
//! - tests/integration/snapshots/test_std_agent_bb/**
//! - tests/integration/testdata/test_std_agent_bb/**
//! - tests/support/test_std_agent_bb/** (optional)
//!
...
fn run_bb_config_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn bb_stdlib_global_version_roundtrip_persists_after_net_set_config() {
    run_bb_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_bb/bb_stdlib_global_version_roundtrip_persists_after_net_set_config.stdout.txt",
    );
}

#[test]
fn bb_stdlib_global_version_typed_and_raw_reads_match_after_roundtrip() {
    run_bb_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_bb/bb_stdlib_global_version_typed_and_raw_reads_match_after_roundtrip.stdout.txt",
    );
}
