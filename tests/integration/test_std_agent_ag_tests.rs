...
//! - tests/integration/test_std_agent_ag_tests.rs
//! - tests/integration/snapshots/test_std_agent_ag/**
...
#[test]
fn ag_stdlib_send_processes_children_and_find_transaction_by_participants_and_opcode() {
    run_network_success(
...
"#,
        "integration/snapshots/test_std_agent_ag/ag_stdlib_send_processes_children_and_find_transaction_by_participants_and_opcode.stdout.txt",
    );
}

#[test]
fn ag_stdlib_send_single_keeps_child_list_empty_and_preserves_out_message() {
    run_network_success(
...
"#,
        "integration/snapshots/test_std_agent_ag/ag_stdlib_send_single_keeps_child_list_empty_and_preserves_out_message.stdout.txt",
    );
}

#[test]
fn ag_stdlib_send_external_runs_handler_and_collects_external_out_message() {
    run_network_success(
...
"#,
        "integration/snapshots/test_std_agent_ag/ag_stdlib_send_external_runs_handler_and_collects_external_out_message.stdout.txt",
    );
}

#[test]
fn ag_stdlib_send_external_is_repeatable_and_keeps_incrementing_state() {
    run_network_success(
...
"#,
        "integration/snapshots/test_std_agent_ag/ag_stdlib_send_external_is_repeatable_and_keeps_incrementing_state.stdout.txt",
    );
}

#[test]
fn ag_stdlib_find_transaction_matches_body_hash_and_returns_null_for_mismatch() {
    run_network_success(
...
"#,
        "integration/snapshots/test_std_agent_ag/ag_stdlib_find_transaction_matches_body_hash_and_returns_null_for_mismatch.stdout.txt",
    );
}

#[test]
fn ag_stdlib_find_transaction_matches_bounced_opcode_after_prefix() {
    run_network_success(
...
"#,
        "integration/snapshots/test_std_agent_ag/ag_stdlib_find_transaction_matches_bounced_opcode_after_prefix.stdout.txt",
    );
}

#[test]
fn ag_stdlib_wait_returns_true_in_emulation_mode_for_non_empty_and_empty_results() {
    run_network_success(
...
"#,
        "integration/snapshots/test_std_agent_ag/ag_stdlib_wait_returns_true_in_emulation_mode_for_non_empty_and_empty_results.stdout.txt",
    );
}

#[test]
fn ag_stdlib_wait_returns_false_for_empty_list_in_broadcast_mode() {
    run_network_success(
...
"#,
        "integration/snapshots/test_std_agent_ag/ag_stdlib_wait_returns_false_for_empty_list_in_broadcast_mode.stdout.txt",
    );
}

#[test]
fn ag_stdlib_wait_rejects_zero_attempts_in_broadcast_mode() {
    network_project(
...
"#,
    ...
    .assert_snapshot_matches(
        "integration/snapshots/test_std_agent_ag/ag_stdlib_wait_rejects_zero_attempts_in_broadcast_mode.stdout.txt",
    );
}
