//! Reserved for agent-cv.
//! Prefix: cv_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_cv/**
...
fn run_cv_stdlib_project_builder_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn cv_stdlib_out_action_send_message_load_message_and_generic_are_parity_for_inline_body() {
    run_cv_stdlib_project_builder_case(
...
"#,
        "integration/snapshots/test_std_agent_cv/cv_stdlib_out_action_send_message_load_message_and_generic_are_parity_for_inline_body.stdout.txt",
    );
}

#[test]
fn cv_stdlib_out_action_send_message_load_message_and_generic_are_parity_for_ref_body_in_fixture_project()
 {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_cv/cv_stdlib_out_action_send_message_load_message_and_generic_are_parity_for_ref_body_in_fixture_project.stdout.txt",
        );
}
