...
//! Prefix: cp_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_cp/**
...
#[test]
fn cp_stdlib_net_is_deployed_transitions_false_to_true_on_deterministic_deploy_path() {
    let snapshot_path = "integration/snapshots/test_std_agent_cp/cp_stdlib_net_is_deployed_transitions_false_to_true_on_deterministic_deploy_path.stdout.txt";
...
#[test]
fn cp_stdlib_net_is_deployed_transitions_false_to_true_in_fixture_project() {
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_cp/cp_stdlib_net_is_deployed_transitions_false_to_true_in_fixture_project.stdout.txt",
        );
}
