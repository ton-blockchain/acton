...
//! - tests/integration/test_lib_agent_l_tests.rs
//! - tests/integration/snapshots/test_lib_agent_l/**
//! - tests/integration/testdata/test_lib_agent_l/**
//! - tests/support/test_lib_agent_l/** (optional)
//!
...
#[test]
fn l_lib_api_map_contains_and_absence_matchers_pass_for_contract_side_map() {
    map_project(
    ...
    .assert_snapshot_matches(
        "integration/snapshots/test_lib_agent_l/l_lib_api_map_contains_and_absence_matchers_pass_for_contract_side_map.stdout.txt",
    );
}

#[test]
fn l_lib_api_map_empty_matchers_pass_for_empty_contract_side_map() {
    map_project(
    ...
    .assert_passed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test_lib_agent_l/l_lib_api_map_empty_matchers_pass_for_empty_contract_side_map.stdout.txt",
    );
}

#[test]
fn l_lib_api_map_have_length_counts_unique_keys_after_overwrite() {
    map_project(
    ...
    .assert_passed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test_lib_agent_l/l_lib_api_map_have_length_counts_unique_keys_after_overwrite.stdout.txt",
    );
}

#[test]
fn l_lib_api_map_to_contain_key_failure_reports_missing_key() {
    map_project(
    ...
    .assert_failed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test_lib_agent_l/l_lib_api_map_to_contain_key_failure_reports_missing_key.stdout.txt",
    );
}

#[test]
fn l_lib_api_map_to_not_contain_value_failure_reports_present_value() {
    map_project(
    ...
    .assert_failed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test_lib_agent_l/l_lib_api_map_to_not_contain_value_failure_reports_present_value.stdout.txt",
    );
}
