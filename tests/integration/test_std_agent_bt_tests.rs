...
//! - tests/integration/test_std_agent_bt_tests.rs
//! - tests/integration/snapshots/test_std_agent_bt/**
...
#[test]
fn bt_stdlib_assert_consumes_less_than1_returns_computed_function_result() {
    let source = format!(
        r#"{ASSERT_IMPORTS}
...
"#
    ...
    ProjectBuilder::new("bt-stdlib-assert-consumes-less-than1-pass")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_bt/bt_stdlib_assert_consumes_less_than1_returns_computed_function_result.stdout.txt",
        );
}
