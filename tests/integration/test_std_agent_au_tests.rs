...
//! - tests/integration/test_std_agent_au_tests.rs
//! - tests/integration/snapshots/test_std_agent_au/**
...
#[test]
fn au_stdlib_fs_read_file_returns_null_for_non_utf8_binary_fixture() {
...
"#
    ...
    project
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_au/au_stdlib_fs_read_file_returns_null_for_non_utf8_binary_fixture.stdout.txt",
        );
}
...
"#,
        "integration/snapshots/test_std_agent_au/au_stdlib_fs_read_file_keeps_binary_like_text_content_across_normalized_paths.stdout.txt",
    );
}
