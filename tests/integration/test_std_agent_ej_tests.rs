//! Reserved integration test module for subagent EJ.
//!
//! Ownership boundary for agent EJ:
//! - tests/integration/test_std_agent_ej_tests.rs
//! - tests/integration/snapshots/test_std_agent_ej/**
//! - tests/integration/testdata/test_std_agent_ej/**
//! - tests/support/test_std_agent_ej/** (optional)
//!
...
#[test]
fn ej_stdlib_assert_not_equal_reports_diagnostics_for_complex_tuple_and_map_values() {
    let source = format!(
        r#"{ASSERT_IMPORTS}
...
"#
    ...
    ProjectBuilder::new("ej-stdlib-assert-not-equal-complex-tuple-map")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_ej/ej_stdlib_assert_not_equal_reports_diagnostics_for_complex_tuple_and_map_values.stdout.txt",
        );
}
