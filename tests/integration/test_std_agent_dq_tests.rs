//! Reserved integration test module for subagent DQ.
//!
//! Ownership boundary for agent DQ:
//! - tests/integration/test_std_agent_dq_tests.rs
//! - tests/integration/snapshots/test_std_agent_dq/**
//! - tests/integration/testdata/test_std_agent_dq/**
//! - tests/support/test_std_agent_dq/** (optional)
//!
...
#[test]
fn dq_stdlib_config_storage_prices_set_initial_overwrites_zero_and_preserves_future_entries() {
...
"#,
        "integration/snapshots/test_std_agent_dq/dq_stdlib_config_storage_prices_set_initial_overwrites_zero_and_preserves_future_entries.stdout.txt",
    );
}
