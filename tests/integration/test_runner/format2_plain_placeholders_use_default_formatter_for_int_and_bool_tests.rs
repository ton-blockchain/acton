...
"#,
        "integration/snapshots/test-runner/format2_plain_placeholders_use_default_formatter_for_int_and_bool/format2_plain_placeholders_use_default_formatter_for_int_and_bool.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/format2_plain_placeholders_use_default_formatter_for_int_and_bool/format2_escaped_braces_around_placeholder_should_collapse_bug.stdout.txt",
    );
}
