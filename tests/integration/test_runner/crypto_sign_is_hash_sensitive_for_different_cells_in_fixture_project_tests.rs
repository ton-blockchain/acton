...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/crypto_sign_is_hash_sensitive_for_different_cells_in_fixture_project/crypto_sign_is_hash_sensitive_for_different_cells_in_fixture_project.stdout.txt",
        );
}
