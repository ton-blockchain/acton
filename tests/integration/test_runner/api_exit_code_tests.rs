...
fn expect_to_end_with_exit_code_marks_controlled_throw_as_pass() {
    ProjectBuilder::new("m-lib-api-expected-throw-pass")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_exit_code/expect_to_end_with_exit_code_marks_controlled_throw_as_pass.stdout.txt",
        );
}
...
fn expect_to_end_with_exit_code_reports_mismatched_throw() {
    ProjectBuilder::new("m-lib-api-exit-code-mismatch")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_exit_code/expect_to_end_with_exit_code_reports_mismatched_throw.stdout.txt",
        );
}
...
fn expect_to_end_with_exit_code_overrides_fail_with_annotation() {
    ProjectBuilder::new("m-lib-api-override-annotation")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_exit_code/expect_to_end_with_exit_code_overrides_fail_with_annotation.stdout.txt",
        );
}
...
fn expect_to_end_with_exit_code_last_call_wins() {
    ProjectBuilder::new("m-lib-api-last-exit-code-wins")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_exit_code/expect_to_end_with_exit_code_last_call_wins.stdout.txt",
        );
}
...
fn expect_to_end_with_exit_code_conditional_path_without_expect_fails_with_raw_exit_code() {
    ProjectBuilder::new("m-lib-api-conditional-expect")
        ...
        .assert_not_contains("Expected exit_code=")
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_exit_code/expect_to_end_with_exit_code_conditional_path_without_expect_fails_with_raw_exit_code.stdout.txt",
        );
}
