...
"#,
        "integration/snapshots/test-runner/send_processes_children_and_find_transaction_by_participants_and_opcode/send_processes_children_and_find_transaction_by_participants_and_opcode.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/send_processes_children_and_find_transaction_by_participants_and_opcode/send_single_keeps_child_list_empty_and_preserves_out_message.stdout.txt",
    );
}
...
"#,
    ...
    .assert_snapshot_matches(
        "integration/snapshots/test-runner/send_processes_children_and_find_transaction_by_participants_and_opcode/wait_rejects_zero_attempts_in_broadcast_mode.stdout.txt",
    );
}
