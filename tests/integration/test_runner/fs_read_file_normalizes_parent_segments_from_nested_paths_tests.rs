...
"#,
        "integration/snapshots/test-runner/fs_read_file_normalizes_parent_segments_from_nested_paths/fs_read_file_normalizes_parent_segments_from_nested_paths.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/fs_read_file_normalizes_parent_segments_from_nested_paths/fs_read_file_repeated_normalized_reads_are_stable.stdout.txt",
        );
}
