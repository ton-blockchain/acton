...
"#,
        "integration/snapshots/test-runner/set_c5_roundtrip_restores_single_and_double_action_out_lists/set_c5_roundtrip_restores_single_and_double_action_out_lists.stdout.txt",
    );
}
