...
"#,
        "integration/snapshots/test-runner/send_result_all_out_actions_flattens_root_and_child_transactions_in_project_builder/send_result_all_out_actions_flattens_root_and_child_transactions_in_project_builder.stdout.txt",
    );
}
...
"#;
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/send_result_all_out_actions_flattens_root_and_child_transactions_in_project_builder/send_result_all_out_actions_handles_terminal_transaction_without_actions_in_fixture_project.stdout.txt",
        );
}
