...
"#,
        "integration/snapshots/test-runner/config_raw_param_roundtrip_for_global_version_cell/config_msg_forward_prices_update_changes_forward_fee_opcode_result.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/config_raw_param_roundtrip_for_global_version_cell/config_gas_price_change_affects_run_get_method_result.stdout.txt",
    );
}
