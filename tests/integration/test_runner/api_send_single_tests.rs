...
fn send_single_keeps_out_messages_without_executing_children() {
    ...
    project
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_send_single/send_single_keeps_out_messages_without_executing_children.stdout.txt",
        );
}
...
fn send_executes_child_transactions_and_matches_notify_expectation() {
    ...
    project
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_send_single/send_executes_child_transactions_and_matches_notify_expectation.stdout.txt",
        );
}
...
fn send_single_bounce_roundtrip_matches_bounced_notify_opcode() {
    ...
    project
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_send_single/send_single_bounce_roundtrip_matches_bounced_notify_opcode.stdout.txt",
        );
}
...
fn send_single_bounce_roundtrip_matches_failed_tx_exit_code() {
    ...
    project
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/api_send_single/send_single_bounce_roundtrip_matches_failed_tx_exit_code.stdout.txt",
        );
}
