...
"#,
        "integration/snapshots/test-runner/format4_ignores_extra_arguments_when_template_has_only_two_placeholders/format4_leaves_unmatched_placeholder_when_template_has_five_slots.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/format4_ignores_extra_arguments_when_template_has_only_two_placeholders/format2_escaped_braces_are_treated_as_literals.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/format4_ignores_extra_arguments_when_template_has_only_two_placeholders/format1_supports_utf8_literals_with_plain_placeholder.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/format4_ignores_extra_arguments_when_template_has_only_two_placeholders/format1_escaped_braces_without_placeholders_render_as_literals.stdout.txt",
    );
}
