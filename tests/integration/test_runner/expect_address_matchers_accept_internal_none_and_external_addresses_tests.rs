...
"#,
        "integration/snapshots/test-runner/expect_address_matchers_accept_internal_none_and_external_addresses/expect_address_matchers_accept_internal_none_and_external_addresses.stdout.txt",
    );
}
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/expect_address_matchers_accept_internal_none_and_external_addresses/expect_address_matchers_report_assertion_failures_for_wrong_kinds.stdout.txt",
        );
}
