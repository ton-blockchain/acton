...
"#,
        "integration/snapshots/test-runner/outlist_to_be_non_empty_passes_for_single_send_action/outlist_to_be_non_empty_passes_for_single_send_action.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/outlist_to_be_non_empty_passes_for_single_send_action/outlist_to_be_send_message_at_extracts_typed_body.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/outlist_to_be_non_empty_passes_for_single_send_action/outlist_to_be_send_message_at_opcode_mismatch_reports_known_type.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/outlist_to_be_non_empty_passes_for_single_send_action/outlist_to_be_send_message_at_opcode_mismatch_without_known_type_name.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/outlist_to_be_non_empty_passes_for_single_send_action/outlist_to_be_send_message_at_bounced_prefix_opcode_mismatch_is_reported.stdout.txt",
    );
}
