...
"#,
        "integration/snapshots/test-runner/map_value_matchers_support_typed_any_address_values/map_value_matchers_support_typed_any_address_values.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/map_value_matchers_support_typed_any_address_values/map_value_matchers_report_typed_any_address_mismatches.stdout.txt",
        2,
    );
}
