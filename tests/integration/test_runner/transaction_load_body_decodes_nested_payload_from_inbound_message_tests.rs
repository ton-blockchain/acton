...
"#,
        "integration/snapshots/test-runner/transaction_load_body_decodes_nested_payload_from_inbound_message/transaction_load_body_decodes_nested_payload_from_inbound_message.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/transaction_load_body_decodes_nested_payload_from_inbound_message/transaction_load_body_decodes_nested_payload_in_fixture_project.stdout.txt",
        );
}
