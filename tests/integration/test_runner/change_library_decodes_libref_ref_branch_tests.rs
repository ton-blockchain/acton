...
"#,
        "integration/snapshots/test-runner/change_library_decodes_libref_ref_branch/change_library_decodes_libref_ref_branch.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/change_library_decodes_libref_ref_branch/change_library_mode_is_preserved_for_remove_action.stdout.txt",
    );
}
