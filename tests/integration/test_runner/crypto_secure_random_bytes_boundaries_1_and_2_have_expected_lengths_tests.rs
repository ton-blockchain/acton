...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/crypto_secure_random_bytes_boundaries_1_and_2_have_expected_lengths/crypto_secure_random_bytes_size_2_keeps_length_across_calls_in_fixture_project.stdout.txt",
        );
}
