...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/vm_set_block_and_logical_time_are_independent_in_c7_slots/vm_set_logical_then_block_time_preserves_slot_isolation_in_fixture_project.stdout.txt",
        );
}
