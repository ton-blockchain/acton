...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/format5_mixed_specifiers_should_follow_placeholder_order_bug/format5_mixed_specifiers_should_follow_placeholder_order_in_fixture_project_bug.stdout.txt",
        );
}
