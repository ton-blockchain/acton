...
"#
    ...
    project
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/fs_read_file_returns_null_for_non_utf8_binary_fixture/fs_read_file_returns_null_for_non_utf8_binary_fixture.stdout.txt",
        );
}
...
"#,
        "integration/snapshots/test-runner/fs_read_file_returns_null_for_non_utf8_binary_fixture/fs_read_file_keeps_binary_like_text_content_across_normalized_paths.stdout.txt",
    );
}
