...
"#,
        "integration/snapshots/test-runner/expect_map_to_contain_key_supports_address_keys/expect_map_to_contain_key_supports_address_keys.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/expect_map_to_contain_key_supports_address_keys/expect_map_to_contain_key_fails_for_equivalent_friendly_address_bug.stdout.txt",
    );
}
