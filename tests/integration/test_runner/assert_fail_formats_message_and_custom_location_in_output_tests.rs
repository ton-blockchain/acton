...
"#,
    ...
    ProjectBuilder::new("bv-stdlib-assert-fail-custom-location")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/assert_fail_formats_message_and_custom_location_in_output/assert_fail_formats_message_and_custom_location_in_output.stdout.txt",
        );
}
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/assert_fail_formats_message_and_custom_location_in_output/assert_fail_honors_expected_exit_code_path_in_fixture_project.stdout.txt",
        );
}
