...
"
    ...
    run_expect_suite("by-stdlib-expect-bool-pass", &source)
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/expect_bool_matchers_pass_for_true_and_false_values/expect_bool_matchers_pass_for_true_and_false_values.stdout.txt",
        );
}
...
"
    ...
    run_expect_suite("by-stdlib-expect-bool-fail", &source)
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/expect_bool_matchers_pass_for_true_and_false_values/expect_bool_matcher_mismatch_reports_tuple_diff.stdout.txt",
        );
}
