...
"#,
        "integration/snapshots/test-runner/vm_register_library_is_idempotent_under_repeated_same_cell_registration/vm_register_library_is_idempotent_under_repeated_same_cell_registration.stdout.txt",
    );
}
