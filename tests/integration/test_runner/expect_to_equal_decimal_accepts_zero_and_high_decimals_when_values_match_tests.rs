...
"#,
    ...
    ProjectBuilder::new("ef-stdlib-decimal-equality-zero-high-precision")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/expect_to_equal_decimal_accepts_zero_and_high_decimals_when_values_match/expect_to_equal_decimal_accepts_zero_and_high_decimals_when_values_match.stdout.txt",
        );
}
...
"#,
    ...
    ProjectBuilder::new("ef-stdlib-decimal-failure-format-zero-high")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/expect_to_equal_decimal_accepts_zero_and_high_decimals_when_values_match/expect_to_equal_decimal_formats_zero_and_high_decimal_failures.stdout.txt",
        );
}
