//! Reserved integration test module for subagent DI.
//!
//! Ownership boundary for agent DI:
//! - tests/integration/test_std_agent_di_tests.rs
//! - tests/integration/snapshots/test_std_agent_di/**
//!
...
fn run_di_network_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn di_stdlib_net_set_now_overwrites_timestamp_across_multiple_updates_in_project_builder() {
    run_di_network_success_case(
...
"#,
        "integration/snapshots/test_std_agent_di/di_stdlib_net_set_now_overwrites_timestamp_across_multiple_updates_in_project_builder.stdout.txt",
    );
}

#[test]
fn di_stdlib_net_set_now_handles_boundary_and_followup_overwrite_in_fixture_project() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_di/di_stdlib_net_set_now_handles_boundary_and_followup_overwrite_in_fixture_project.stdout.txt",
        );
}
