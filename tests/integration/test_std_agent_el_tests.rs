//! Reserved integration test module for subagent EL.
//!
//! Ownership boundary for agent EL:
//! - tests/integration/test_std_agent_el_tests.rs
//! - tests/integration/snapshots/test_std_agent_el/**
//! - tests/integration/testdata/test_std_agent_el/**
//! - tests/support/test_std_agent_el/** (optional)
//!
...
#[test]
fn el_stdlib_assert_fail_wallet_not_found_direct_call_without_wallets_shows_setup_hint() {
...
#[test]
fn el_stdlib_assert_fail_wallet_not_found_direct_call_with_loaded_wallets_lists_available_wallets()
{
    let location = "scripts/el_assert_fail_wallet_not_found.tolk:5:5";
    let home_temp = TempDir::new().expect("failed to create HOME tempdir");
    let home = home_temp
