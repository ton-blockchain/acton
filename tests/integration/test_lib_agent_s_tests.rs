...
#[test]
fn s_lib_api_wallet_uses_local_treasury_when_broadcast_disabled() {
...
"#,
        "integration/snapshots/test_lib_agent_s/s_lib_api_wallet_uses_local_treasury_when_broadcast_disabled.stdout.txt",
    );
}

#[test]
fn s_lib_api_enable_broadcast_wallet_lookup_requires_configured_wallet() {
...
"#,
    ...
    ProjectBuilder::new("s-lib-api-enable-broadcast-wallet-lookup")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_lib_agent_s/s_lib_api_enable_broadcast_wallet_lookup_requires_configured_wallet.stdout.txt",
        );
}

#[test]
fn s_lib_api_disable_broadcast_restores_local_wallet_resolution() {
    run_wallet_mode_success(
...
"#,
        "integration/snapshots/test_lib_agent_s/s_lib_api_disable_broadcast_restores_local_wallet_resolution.stdout.txt",
    );
}

#[test]
fn s_lib_api_broadcast_toggle_roundtrip_updates_mode() {
    run_wallet_mode_success(
...
"#,
        "integration/snapshots/test_lib_agent_s/s_lib_api_broadcast_toggle_roundtrip_updates_mode.stdout.txt",
    );
}

#[test]
fn s_lib_api_local_wallet_names_map_to_distinct_treasuries() {
    run_wallet_mode_success(
...
"#,
        "integration/snapshots/test_lib_agent_s/s_lib_api_local_wallet_names_map_to_distinct_treasuries.stdout.txt",
    );
}
