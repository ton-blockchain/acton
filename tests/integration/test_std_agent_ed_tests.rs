...
//! - tests/integration/test_std_agent_ed_tests.rs
//! - tests/integration/snapshots/test_std_agent_ed/**
...
#[test]
fn ed_stdlib_map_value_matchers_support_typed_any_address_values() {
    run_ed_success(
...
"#,
        "integration/snapshots/test_std_agent_ed/ed_stdlib_map_value_matchers_support_typed_any_address_values.stdout.txt",
    );
}

#[test]
fn ed_stdlib_map_value_matchers_report_typed_any_address_mismatches() {
    run_ed_failure(
...
"#,
        "integration/snapshots/test_std_agent_ed/ed_stdlib_map_value_matchers_report_typed_any_address_mismatches.stdout.txt",
        2,
    );
}
