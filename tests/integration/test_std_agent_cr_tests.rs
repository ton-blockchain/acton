//! Reserved for agent-cr.
//! Prefix: cr_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_cr/**
...
fn run_cr_project_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn cr_stdlib_register_code_cell_duplicate_name_is_hash_specific() {
    run_cr_project_case(
...
"#,
        "integration/snapshots/test_std_agent_cr/cr_stdlib_register_code_cell_duplicate_name_is_hash_specific.stdout.txt",
    );
}

#[test]
fn cr_stdlib_register_code_cell_duplicate_name_last_registration_wins_for_same_hash() {
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_cr/cr_stdlib_register_code_cell_duplicate_name_last_registration_wins_for_same_hash.stdout.txt",
        );
}
