...
#[test]
fn eb_stdlib_format1_rejects_unknown_modifier_in_placeholder() {
    run_fmt_failure(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format1_rejects_unknown_modifier_in_placeholder.stdout.txt",
        &["Invalid format string", "unknown format modifier 'hex'"],
    );
}

#[test]
fn eb_stdlib_format1_rejects_empty_modifier_in_placeholder() {
    run_fmt_failure(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format1_rejects_empty_modifier_in_placeholder.stdout.txt",
        &["Invalid format string", "unknown format modifier ''"],
    );
}

#[test]
fn eb_stdlib_format1_rejects_unsupported_placeholder_payload() {
    run_fmt_failure(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format1_rejects_unsupported_placeholder_payload.stdout.txt",
        &["Invalid format string", "unsupported placeholder {name}"],
    );
}

#[test]
fn eb_stdlib_format1_rejects_unclosed_open_brace() {
    run_fmt_failure(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format1_rejects_unclosed_open_brace.stdout.txt",
        &["Invalid format string", "unclosed '{' placeholder"],
    );
}

#[test]
fn eb_stdlib_format1_rejects_unmatched_closing_brace() {
    run_fmt_failure(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format1_rejects_unmatched_closing_brace.stdout.txt",
        &["Invalid format string", "unmatched '}'"],
    );
}

#[test]
fn eb_stdlib_format2_escaped_braces_are_treated_as_literals() {
    run_fmt_success(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format2_escaped_braces_are_treated_as_literals.stdout.txt",
    );
}

#[test]
fn eb_stdlib_format1_supports_utf8_literals_with_plain_placeholder() {
    run_fmt_success(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format1_supports_utf8_literals_with_plain_placeholder.stdout.txt",
    );
}

#[test]
fn eb_stdlib_format1_escaped_braces_without_placeholders_render_as_literals() {
    run_fmt_success(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format1_escaped_braces_without_placeholders_render_as_literals.stdout.txt",
    );
}

#[test]
fn eb_stdlib_format1_rejects_invalid_modifier_payload() {
    run_fmt_failure(
...
"#,
        "integration/snapshots/test_std_agent_eb/eb_stdlib_format1_rejects_invalid_modifier_payload.stdout.txt",
