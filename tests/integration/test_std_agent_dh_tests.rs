...
//! Prefix: dh_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_dh/**
...
#[test]
fn dh_stdlib_create_external_message_honors_explicit_external_src_and_omits_state_init() {
    run_dh_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dh/dh_stdlib_create_external_message_honors_explicit_external_src_and_omits_state_init.stdout.txt",
    );
}

#[test]
fn dh_stdlib_create_external_message_defaults_src_to_none_and_keeps_state_init_absent() {
    run_dh_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dh/dh_stdlib_create_external_message_defaults_src_to_none_and_keeps_state_init_absent.stdout.txt",
    );
}
