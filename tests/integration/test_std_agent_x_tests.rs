...
//! - tests/integration/test_std_agent_x_tests.rs
//! - tests/integration/snapshots/test_std_agent_x/**
...
#[test]
fn x_stdlib_build_accepts_contract_name_and_explicit_path() {
    ProjectBuilder::new("x-stdlib-build-by-name-and-path")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_x/x_stdlib_build_accepts_contract_name_and_explicit_path.stdout.txt",
        );
}

#[test]
fn x_stdlib_build_reports_missing_contract_when_path_is_omitted() {
    ProjectBuilder::new("x-stdlib-build-contract-not-found")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_x/x_stdlib_build_reports_missing_contract_when_path_is_omitted.stdout.txt",
        );
}
