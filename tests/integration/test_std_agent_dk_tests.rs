//! Reserved integration test module for subagent DK.
//!
//! Ownership boundary for agent DK:
//! - tests/integration/test_std_agent_dk_tests.rs
//! - tests/integration/snapshots/test_std_agent_dk/**
//! - tests/integration/testdata/test_std_agent_dk/**
//! - tests/support/test_std_agent_dk/** (optional)
//!
...
fn run_dk_vm_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn dk_stdlib_vm_get_config_unpacked_stays_stable_after_set_config_root_dict_mutation() {
    run_dk_vm_success_case(
...
"#,
        "integration/snapshots/test_std_agent_dk/dk_stdlib_vm_get_config_unpacked_stays_stable_after_set_config_root_dict_mutation.stdout.txt",
    );
}
