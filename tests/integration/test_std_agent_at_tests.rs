...
//! - tests/integration/test_std_agent_at_tests.rs
//! - tests/integration/snapshots/test_std_agent_at/**
...
#[test]
fn at_stdlib_keeps_stdout_and_stderr_separated_when_stderr_happens_first() {
    run_stdlib_io_case(
...
"#,
        "integration/snapshots/test_std_agent_at/at_stdlib_keeps_stdout_and_stderr_separated_when_stderr_happens_first.stdout.txt",
    );
}

#[test]
fn at_stdlib_preserves_stdout_order_during_interleaved_println_and_eprintln() {
    run_stdlib_io_case(
...
"#,
        "integration/snapshots/test_std_agent_at/at_stdlib_preserves_stdout_order_during_interleaved_println_and_eprintln.stdout.txt",
    );
}
