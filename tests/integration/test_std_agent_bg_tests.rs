//! Reserved integration test module for subagent BG.
//!
//! Ownership boundary for agent BG:
//! - tests/integration/test_std_agent_bg_tests.rs
//! - tests/integration/snapshots/test_std_agent_bg/**
//! - tests/integration/testdata/test_std_agent_bg/**
//! - tests/support/test_std_agent_bg/** (optional)
//!
...
#[test]
fn bg_stdlib_run_get_method_by_id_fails_for_undeployed_contract() {
    let snapshot_path = "integration/snapshots/test_std_agent_bg/bg_stdlib_run_get_method_by_id_fails_for_undeployed_contract.stdout.txt";
...
#[test]
fn bg_stdlib_run_get_method_by_id_fails_for_invalid_method_id_on_deployed_contract() {
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_bg/bg_stdlib_run_get_method_by_id_fails_for_invalid_method_id_on_deployed_contract.stdout.txt",
        );
}
