//! Reserved integration test module for subagent BC.
//!
//! Ownership boundary for agent BC:
//! - tests/integration/test_std_agent_bc_tests.rs
//! - tests/integration/snapshots/test_std_agent_bc/**
//! - tests/integration/testdata/test_std_agent_bc/**
//! - tests/support/test_std_agent_bc/** (optional)
//!
...
#[test]
fn bc_stdlib_config_storage_prices_multi_entry_roundtrip_keeps_initial_and_future_entries() {
...
"#,
        "integration/snapshots/test_std_agent_bc/bc_stdlib_config_storage_prices_multi_entry_roundtrip_keeps_initial_and_future_entries.stdout.txt",
    );
}

#[test]
fn bc_stdlib_config_storage_prices_set_initial_overwrites_index_zero_only() {
    run_config_success_case(
...
"#,
        "integration/snapshots/test_std_agent_bc/bc_stdlib_config_storage_prices_set_initial_overwrites_index_zero_only.stdout.txt",
    );
}
