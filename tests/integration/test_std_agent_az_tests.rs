...
//! - tests/integration/test_std_agent_az_tests.rs
//! - tests/integration/snapshots/test_std_agent_az/**
...
"#,
        "integration/snapshots/test_std_agent_az/az_stdlib_crypto_fast_random_bytes_without_seed_is_deterministic_for_fixed_vm_time.stdout.txt",
    );
}
