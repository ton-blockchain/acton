...
//! - tests/integration/test_std_agent_dx_tests.rs
//! - tests/integration/snapshots/test_std_agent_dx/**
...
#[test]
fn dx_stdlib_mnemonic_to_keypair_is_deterministic_for_repeated_calls() {
    run_dx_crypto_case(
...
"#,
        "integration/snapshots/test_std_agent_dx/dx_stdlib_mnemonic_to_keypair_is_deterministic_for_repeated_calls.stdout.txt",
    );
}
