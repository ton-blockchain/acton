...
//! - tests/integration/test-runner/test_runner_stdlib_bf_wallet_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bf_wallet_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bf_wallet_tests/bf_stdlib_wallet_matches_treasury_address_without_broadcast.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bf_wallet_tests/bf_stdlib_wallet_unknown_name_uses_treasury_and_sends_in_non_broadcast_mode.stdout.txt",
    );
}
