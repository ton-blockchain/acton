...
//! - tests/integration/test-runner/test_runner_stdlib_be_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_be_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_be_config_tests/be_stdlib_config_set_msg_forward_prices_keeps_basechain_and_masterchain_isolated.stdout.txt",
    );
}
