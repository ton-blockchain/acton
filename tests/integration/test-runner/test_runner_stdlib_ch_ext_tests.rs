...
//! - tests/integration/test-runner/test_runner_stdlib_ch_ext_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ch_ext_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ch_ext_tests/ch_stdlib_ext_message_relaxed_load_body_returns_left_value.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ch_ext_tests/ch_stdlib_ext_message_relaxed_load_body_loads_right_cell_value.stdout.txt",
    );
}
