...
//! - tests/integration/test-runner/test_runner_stdlib_cf_to_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cf_to_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cf_to_tests/cf_stdlib_to_consume_less_than_accepts_threshold_above_measured_gas.stdout.txt",
    );
}
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_cf_to_tests/cf_stdlib_to_consume_less_than_fails_on_equal_threshold_boundary.stdout.txt",
        );
}
