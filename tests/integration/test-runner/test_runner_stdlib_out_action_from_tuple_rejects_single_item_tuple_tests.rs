...
fn run_failure(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn out_action_from_tuple_rejects_single_item_tuple() {
    run_failure(
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_out_action_from_tuple_rejects_single_item_tuple_tests/out_action_from_tuple_rejects_single_item_tuple.stdout.txt",
    );
}

#[test]
fn out_action_from_tuple_rejects_oversized_tuple_in_fixture_project() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_out_action_from_tuple_rejects_single_item_tuple_tests/out_action_from_tuple_rejects_oversized_tuple_in_fixture_project.stdout.txt",
        );
}

#[test]
fn parse_out_actions_rejects_node_without_prev_ref() {
    run_failure_with_contains(
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_out_action_from_tuple_rejects_single_item_tuple_tests/parse_out_actions_rejects_node_without_prev_ref.stdout.txt",
