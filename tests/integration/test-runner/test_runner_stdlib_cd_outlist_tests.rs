...
//! - tests/integration/test-runner/test_runner_stdlib_cd_outlist_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cd_outlist_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cd_outlist_tests/cd_stdlib_outlist_to_be_non_empty_empty_list_reports_failure_message.stdout.txt",
    );
}
