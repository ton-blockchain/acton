//! Reserved integration test module for subagent DC.
//!
//! Ownership boundary for agent DC:
//! - tests/integration/test-runner/test_runner_stdlib_dc_transaction_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dc_transaction_tests/**
//! - tests/integration/testdata/test_std_agent_dc/**
//! - tests/support/test_std_agent_dc/** (optional)
//!
...
fn run_dc_transaction_success(project_name: &str, test_body: &str, snapshot_path: &str) {
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dc_transaction_tests/dc_stdlib_transaction_get_account_address_defaults_to_basechain_and_masterchain_override_changes_only_workchain.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_dc_transaction_tests/dc_stdlib_transaction_get_account_address_masterchain_override_is_stable_in_fixture_project.stdout.txt",
        );
}
