//! Reserved integration test module for subagent CL.
//!
//! Ownership boundary for agent CL:
//! - tests/integration/test-runner/test_runner_stdlib_cl_set_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cl_set_tests/**
//! - tests/integration/testdata/test_std_agent_cl/**
//! - tests/support/test_std_agent_cl/** (optional)
//!
...
fn run_cl_vm_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cl_set_tests/cl_stdlib_set_config_param_keeps_neighbor_slots_consistent.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cl_set_tests/cl_stdlib_set_config_param_slot_three_updates_blockchain_now_and_c7.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cl_set_tests/cl_stdlib_get_config_param_tuple_read_is_not_usable_bug.stdout.txt",
    );
}
