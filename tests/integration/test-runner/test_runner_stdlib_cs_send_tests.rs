...
//! - tests/integration/test-runner/test_runner_stdlib_cs_send_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cs_send_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cs_send_tests/cs_stdlib_send_result_all_out_actions_flattens_root_and_child_transactions_in_project_builder.stdout.txt",
    );
}
...
"#;
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_cs_send_tests/cs_stdlib_send_result_all_out_actions_handles_terminal_transaction_without_actions_in_fixture_project.stdout.txt",
        );
}
