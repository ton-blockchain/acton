...
//! - tests/integration/test-runner/test_runner_stdlib_ee_expect_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ee_expect_tests/**
...
fn expect_map_to_have_length_accepts_empty_and_single_entry_maps() {
    ...
    .assert_snapshot_matches(
        "integration/snapshots/test-runner/test_runner_stdlib_ee_expect_tests/ee_stdlib_expect_map_to_have_length_accepts_empty_and_single_entry_maps.stdout.txt",
    );
}
...
fn expect_map_to_have_length_reports_boundary_mismatch_for_single_entry_map() {
    ...
    .assert_failed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test-runner/test_runner_stdlib_ee_expect_tests/ee_stdlib_expect_map_to_have_length_reports_boundary_mismatch_for_single_entry_map.stdout.txt",
    );
}
