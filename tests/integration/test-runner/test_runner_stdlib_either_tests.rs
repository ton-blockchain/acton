//! Integration tests for AB either helper coverage.
//!
//! Ownership boundary for agent AB:
//! - tests/integration/test-runner/test_runner_stdlib_either_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_either/**
...
fn either_left_and_right_encode_expected_tag_bits() {
    run_either_case(
        ...
        "#,
        "integration/snapshots/test-runner/test_runner_stdlib_either/ab_stdlib_either_left_and_right_encode_expected_tag_bits.stdout.txt",
    );
}
...
fn either_match_routes_left_and_right_variants() {
    run_either_case(
        ...
        "#,
        "integration/snapshots/test-runner/test_runner_stdlib_either/ab_stdlib_either_match_routes_left_and_right_variants.stdout.txt",
    );
}
