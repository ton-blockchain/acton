...
//! - tests/integration/test-runner/test_runner_stdlib_dn_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dn_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dn_config_tests/dn_stdlib_config_get_msg_forward_prices_returns_per_chain_values_after_both_writes.stdout.txt",
    );
}
