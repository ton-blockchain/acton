...
//! - tests/integration/test-runner/test_runner_stdlib_dr_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dr_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dr_config_tests/dr_stdlib_config_storage_prices_roundtrip_preserves_multiple_timestamp_entries.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dr_config_tests/dr_stdlib_config_storage_prices_roundtrip_replaces_old_dictionary_entries_on_second_write.stdout.txt",
    );
}
