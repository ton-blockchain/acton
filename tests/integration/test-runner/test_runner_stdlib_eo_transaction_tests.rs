//! Reserved integration test module for subagent EO.
//!
//! Ownership boundary for agent EO:
//! - tests/integration/test-runner/test_runner_stdlib_eo_transaction_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_eo_transaction_tests/**
//! - tests/integration/testdata/test_std_agent_eo/** (optional)
//! - tests/support/test_std_agent_eo/** (optional)
//!
...
fn run_eo_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eo_transaction_tests/eo_stdlib_transaction_varuint_unpack_from_slice_supports_canonical_boundary_values.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eo_transaction_tests/eo_stdlib_transaction_varuint7_pack_to_builder_roundtrip_boundary_bug.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eo_transaction_tests/eo_stdlib_transaction_varuint3_pack_to_builder_roundtrip_boundary_bug.stdout.txt",
    );
}
