...
//! - tests/integration/test-runner/test_runner_stdlib_dz_crypto_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dz_crypto_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dz_crypto_tests/dz_stdlib_crypto_sign_is_deterministic_for_same_key_and_cell.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_dz_crypto_tests/dz_stdlib_crypto_sign_has_512bit_slice_shape_and_matches_raw_sign_in_fixture_project.stdout.txt",
        );
}
