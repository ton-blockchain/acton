...
//! - tests/integration/test-runner/test_runner_stdlib_ak_load_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/ak_stdlib_load_opcode_reads_opcode_from_either_left_body.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/ak_stdlib_load_opcode_reads_opcode_from_either_right_body_ref.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/ak_stdlib_load_opcode_returns_null_for_either_right_without_ref.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/ak_stdlib_load_opcode_returns_null_when_body_too_short.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/ak_stdlib_load_opcode_without_skip_bounce_returns_bounce_prefix.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/ak_stdlib_load_opcode_with_skip_bounce_returns_nested_opcode.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/ak_stdlib_message_relaxed_load_body_returns_either_left_value.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ak_load_tests/ak_stdlib_message_relaxed_load_body_returns_either_right_cell_value.stdout.txt",
    );
}
