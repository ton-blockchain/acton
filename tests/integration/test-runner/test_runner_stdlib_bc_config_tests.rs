...
//! - tests/integration/test-runner/test_runner_stdlib_bc_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bc_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bc_config_tests/bc_stdlib_config_storage_prices_multi_entry_roundtrip_keeps_initial_and_future_entries.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bc_config_tests/bc_stdlib_config_storage_prices_set_initial_overwrites_index_zero_only.stdout.txt",
    );
}
