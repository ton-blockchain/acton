...
//! - tests/integration/test-runner/test_runner_stdlib_ba_crypto_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ba_crypto_tests/**
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_ba_crypto_tests/ba_stdlib_crypto_sign_is_hash_sensitive_for_different_cells_in_fixture_project.stdout.txt",
        );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ba_crypto_tests/ba_stdlib_crypto_raw_sign_positive_and_negative_hash_values_do_not_collapse.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ba_crypto_tests/ba_stdlib_crypto_raw_sign_positive_and_negative_private_keys_do_not_collapse.stdout.txt",
    );
}
