...
//! - tests/integration/test-runner/test_runner_stdlib_ci_ext_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ci_ext_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ci_ext_tests/ci_stdlib_ext_message_load_opcode_returns_null_for_either_right_without_ref.stdout.txt",
    );
}
