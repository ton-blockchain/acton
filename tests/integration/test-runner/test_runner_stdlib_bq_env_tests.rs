...
//! - tests/integration/test-runner/test_runner_stdlib_bq_env_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bq_env_tests/**
...
fn env_unsupported_generic_type_triggers_assert_fail_branch() {
    ProjectBuilder::new("bq-stdlib-env-unsupported-generic")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bq_env_tests/bq_stdlib_env_unsupported_generic_type_triggers_assert_fail_branch.stdout.txt",
        );
}
