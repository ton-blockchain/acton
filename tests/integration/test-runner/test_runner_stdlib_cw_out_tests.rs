...
//! Prefix: cw_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_cw_out_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cw_out_tests/cw_stdlib_out_action_send_message_load_body_mismatched_type_reports_exit_code63_diagnostic.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_cw_out_tests/cw_stdlib_out_action_send_message_load_body_mismatched_type_reports_exit_code63_diagnostic_in_fixture_project.stdout.txt",
        );
}
