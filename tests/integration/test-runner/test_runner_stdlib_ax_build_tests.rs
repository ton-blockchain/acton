...
//! - tests/integration/test-runner/test_runner_stdlib_ax_build_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ax_build_tests/**
...
fn build_reports_missing_contract_when_name_is_unknown_and_path_is_empty() {
    ProjectBuilder::new("ax-stdlib-build-missing-contract-empty-path")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_ax_build_tests/ax_stdlib_build_reports_missing_contract_when_name_is_unknown_and_path_is_empty.stdout.txt",
        );
}
...
fn build_reports_missing_contract_when_name_and_path_are_empty() {
    ProjectBuilder::new("ax-stdlib-build-empty-contract-inputs")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_ax_build_tests/ax_stdlib_build_reports_missing_contract_when_name_and_path_are_empty.stdout.txt",
        );
}
