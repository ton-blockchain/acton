...
//! - tests/integration/test-runner/test_runner_stdlib_bs_format2_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bs_format2_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bs_format2_tests/bs_stdlib_format2_plain_placeholders_use_default_formatter_for_int_and_bool.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bs_format2_tests/bs_stdlib_format2_escaped_braces_around_placeholder_should_collapse_bug.stdout.txt",
    );
}
