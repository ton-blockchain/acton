//! Reserved integration test module for subagent BM.
//!
//! Ownership boundary for agent BM:
//! - tests/integration/test-runner/test_runner_stdlib_bm_load_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bm_load_tests/**
//! - tests/integration/testdata/test_std_agent_bm/**
//! - tests/support/test_std_agent_bm/** (optional)
//!
...
"#
    ...
    ProjectBuilder::new("bm-stdlib-load-library-unknown-hash-project-builder")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bm_load_tests/bm_stdlib_load_library_unknown_hash_returns_null_in_project_builder.stdout.txt",
        );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bm_load_tests/bm_stdlib_load_library_unknown_hash_returns_null_in_fixture_project.stdout.txt",
        );
}
