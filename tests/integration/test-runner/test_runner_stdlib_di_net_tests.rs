...
//! - tests/integration/test-runner/test_runner_stdlib_di_net_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_di_net_tests/**
//!
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_di_net_tests/di_stdlib_net_set_now_overwrites_timestamp_across_multiple_updates_in_project_builder.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_di_net_tests/di_stdlib_net_set_now_handles_boundary_and_followup_overwrite_in_fixture_project.stdout.txt",
        );
}
