...
//! Prefix: dm_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_dm_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dm_config_tests/dm_stdlib_config_set_param_raw_get_param_raw_roundtrip_preserves_cell_shape.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dm_config_tests/dm_stdlib_config_set_param_raw_overwrite_keeps_neighbor_slot_unchanged.stdout.txt",
    );
}
