...
//! - tests/integration/test-runner/test_runner_stdlib_eh_env_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_eh_env_tests/**
...
fn env_or_address_falls_back_for_invalid_present_and_uses_valid_present_value() {
    ProjectBuilder::new("eh-stdlib-env-or-address-fallback-vs-valid-precedence")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_eh_env_tests/eh_stdlib_env_or_address_falls_back_for_invalid_present_and_uses_valid_present_value.stdout.txt",
        );
}
...
fn env_or_cell_falls_back_for_invalid_present_and_uses_valid_present_value() {
    ...
    ProjectBuilder::new("eh-stdlib-env-or-cell-fallback-vs-valid-precedence")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_eh_env_tests/eh_stdlib_env_or_cell_falls_back_for_invalid_present_and_uses_valid_present_value.stdout.txt",
        );
}
