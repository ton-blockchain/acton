...
//! - tests/integration/test-runner/test_runner_stdlib_bu_assert_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bu_assert_tests/**
...
"#
    ...
    ProjectBuilder::new("bu-stdlib-assert-consumes-less-than3-pass")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bu_assert_tests/bu_stdlib_assert_consumes_less_than3_returns_computed_result.stdout.txt",
        );
}
...
"#
    ...
    fixture
        ...
        .assert_failed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bu_assert_tests/bu_stdlib_assert_consumes_less_than3_rejects_wrong_callback_arity.stdout.txt",
        );
}
