...
//! - tests/integration/test-runner/test_runner_stdlib_as_println1_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_as_println1_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_as_println1_tests/as_stdlib_println1_formats_negative_hex_and_ton_values.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_as_println1_tests/as_stdlib_println1_formats_edge_hex_and_ton_values.stdout.txt",
    );
}
