...
//! - tests/integration/test-runner/test_runner_stdlib_eb_format1_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format4_ignores_extra_arguments_when_template_has_only_two_placeholders.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format4_leaves_unmatched_placeholder_when_template_has_five_slots.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format1_rejects_unknown_modifier_in_placeholder.stdout.txt",
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format1_rejects_empty_modifier_in_placeholder.stdout.txt",
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format1_rejects_unsupported_placeholder_payload.stdout.txt",
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format1_rejects_unclosed_open_brace.stdout.txt",
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format1_rejects_unmatched_closing_brace.stdout.txt",
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format2_escaped_braces_are_treated_as_literals.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format1_supports_utf8_literals_with_plain_placeholder.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format1_escaped_braces_without_placeholders_render_as_literals.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_eb_format1_tests/eb_stdlib_format1_rejects_invalid_modifier_payload.stdout.txt",
