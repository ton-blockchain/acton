...
//! Prefix: ct_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_ct_ext_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ct_ext_tests/ct_stdlib_ext_out_list_at_or_null_out_of_range_returns_null_bug.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ct_ext_tests/ct_stdlib_ext_out_list_at_or_null_negative_index_returns_null.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ct_ext_tests/ct_stdlib_ext_out_list_at_or_null_opcode_mismatch_returns_null.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ct_ext_tests/ct_stdlib_ext_out_list_at_or_null_valid_index_returns_message.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ct_ext_tests/ct_stdlib_ext_out_list_at_or_null_empty_list_returns_null.stdout.txt",
    );
}
