...
//! Prefix: de_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_de_wait_tests/**
...
fn wait_missing_tx_hash_non_quiet_returns_false() {
    run_wait_missing_hash_case(
        ...
        false,
        "integration/snapshots/test-runner/test_runner_stdlib_de_wait_tests/de_stdlib_wait_missing_tx_hash_non_quiet_returns_false.stdout.txt",
    );
}
...
fn wait_missing_tx_hash_quiet_returns_false_without_wait_log() {
    run_wait_missing_hash_case(
        ...
        true,
        "integration/snapshots/test-runner/test_runner_stdlib_de_wait_tests/de_stdlib_wait_missing_tx_hash_quiet_returns_false_without_wait_log.stdout.txt",
    );
}
