...
//! - tests/integration/test-runner/test_runner_stdlib_ah_balance_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/ah_stdlib_balance_returns_zero_for_unknown_address_then_top_up_updates_balance.stdout.txt",
        &[],
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/ah_stdlib_top_up_is_additive_for_the_same_address.stdout.txt",
        &[],
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/ah_stdlib_set_account_on_fresh_target_preserves_shard_markers.stdout.txt",
        &[],
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/ah_stdlib_set_account_preserves_existing_shard_markers_and_balance.stdout.txt",
        &[],
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/ah_stdlib_set_shard_account_copies_markers_and_balance_between_addresses.stdout.txt",
        &[],
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/ah_stdlib_set_shard_account_null_resets_balance_and_markers.stdout.txt",
        &[],
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/ah_stdlib_register_address_name_is_used_in_transaction_output.stdout.txt",
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ah_balance_tests/ah_stdlib_register_code_cell_name_is_used_for_auto_deploy_output.stdout.txt",
