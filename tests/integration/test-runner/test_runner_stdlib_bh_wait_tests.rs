//! Reserved integration test module for subagent BH.
//!
//! Ownership boundary for agent BH:
//! - tests/integration/test-runner/test_runner_stdlib_bh_wait_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bh_wait_tests/**
//! - tests/integration/testdata/test_std_agent_bh/**
//! - tests/support/test_std_agent_bh/** (optional)
//!
...
"#
    ...
    ProjectBuilder::new("bh-stdlib-wait-for-transaction-emulation-noop")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bh_wait_tests/bh_stdlib_wait_for_transaction_returns_true_in_emulation_mode.stdout.txt",
        );
}
