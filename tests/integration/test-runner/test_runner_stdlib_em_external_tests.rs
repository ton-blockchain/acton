...
//! Prefix: em_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_em_external_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_em_external_tests/em_stdlib_external_out_message_matches_src_to_and_body_prefix_bug.stdout.txt",
    );
}
