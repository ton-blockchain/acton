...
//! - tests/integration/test-runner/test_runner_stdlib_dt_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dt_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dt_config_tests/dt_stdlib_config_get_precompiled_contracts_config_default_decodes_with_builtin_entry.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dt_config_tests/dt_stdlib_config_get_precompiled_contracts_config_roundtrips_explicit_empty_value.stdout.txt",
    );
}
