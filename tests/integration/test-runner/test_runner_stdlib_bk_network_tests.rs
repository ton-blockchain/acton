...
//! - tests/integration/test-runner/test_runner_stdlib_bk_network_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bk_network_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bk_network_tests/bk_stdlib_network_get_account_storage_fee_returns_null_for_missing_account.stdout.txt",
    );
}
...
"#;
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bk_network_tests/bk_stdlib_network_get_account_storage_fee_returns_non_null_for_existing_account_in_fixture_project.stdout.txt",
        );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bk_network_tests/bk_stdlib_account_state_variants_uninit_and_active_are_parsed_from_accounts.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bk_network_tests/bk_stdlib_account_state_frozen_local_roundtrip_cell_works.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bk_network_tests/bk_stdlib_account_state_frozen_roundtrip_via_set_account_bug.stdout.txt",
    );
}
