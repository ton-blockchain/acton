//! Reserved integration test module for subagent Y.
//!
//! Ownership boundary for agent Y:
//! - tests/integration/test-runner/test_runner_stdlib_y_format1_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_y_format1_tests/**
//! - tests/integration/testdata/test_std_agent_y/**
//! - tests/support/test_std_agent_y/** (optional)
//!
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_y_format1_tests/y_stdlib_format1_and_format2_support_plain_hex_and_ton_specifiers.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_y_format1_tests/y_stdlib_format3_and_format4_support_mixed_plain_hex_and_ton.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_y_format1_tests/y_stdlib_format5_should_respect_placeholder_order_for_plain_hex_and_ton_bug.stdout.txt",
    );
}
