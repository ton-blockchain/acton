...
//! Prefix: cr_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_cr_register_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cr_register_tests/cr_stdlib_register_code_cell_duplicate_name_is_hash_specific.stdout.txt",
    );
}
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_cr_register_tests/cr_stdlib_register_code_cell_duplicate_name_last_registration_wins_for_same_hash.stdout.txt",
        );
}
