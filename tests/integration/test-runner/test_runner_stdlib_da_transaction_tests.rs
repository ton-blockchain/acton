...
//! - tests/integration/test-runner/test_runner_stdlib_da_transaction_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_da_transaction_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_da_transaction_tests/da_stdlib_transaction_load_in_msg_decodes_typed_payload_and_matches_inbound_opcode.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_da_transaction_tests/da_stdlib_transaction_load_in_msg_in_fixture_project_matches_inbound_opcode.stdout.txt",
        );
}
