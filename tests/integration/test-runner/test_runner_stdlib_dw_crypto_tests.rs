...
//! Prefix: dw_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_dw_crypto_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dw_crypto_tests/dw_stdlib_crypto_create_mnemonic_returns_24_non_empty_words.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_dw_crypto_tests/dw_stdlib_crypto_create_mnemonic_outputs_are_valid_for_keypair_derivation_in_fixture_project.stdout.txt",
        );
}
