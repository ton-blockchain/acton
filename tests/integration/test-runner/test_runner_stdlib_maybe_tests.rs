//! Integration tests for `Maybe` helper coverage.
//!
//! Ownership boundary for agent AA:
//! - tests/integration/test-runner/test_runner_stdlib_maybe_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_maybe/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_maybe/aa_stdlib_maybe_some_none_unwrap_and_unwrap_or_follow_documented_semantics.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_maybe/aa_stdlib_maybe_unwrap_on_none_throws_exit_code_7.stdout.txt",
    );
}
