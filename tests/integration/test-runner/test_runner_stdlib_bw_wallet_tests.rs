...
//! - tests/integration/test-runner/test_runner_stdlib_bw_wallet_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bw_wallet_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bw_wallet_tests/bw_stdlib_wallet_missing_in_broadcast_without_wallets_config_reports_setup_instructions.stdout.txt",
        None,
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bw_wallet_tests/bw_stdlib_wallet_missing_in_broadcast_with_wallets_config_lists_available_wallets.stdout.txt",
