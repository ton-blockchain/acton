...
//! - tests/integration/test-runner/test_runner_stdlib_eg_assert_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_eg_assert_tests/**
...
"#,
    ...
    ProjectBuilder::new("eg-stdlib-assert-equal-decimal-no-round-half-up")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_eg_assert_tests/eg_stdlib_assert_equal_decimal_does_not_round_half_up_boundaries.stdout.txt",
        );
}
...
"#,
    ...
    ProjectBuilder::new("eg-stdlib-assert-equal-decimal-negative-leading-zero")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_eg_assert_tests/eg_stdlib_assert_equal_decimal_formats_negative_small_values_with_leading_zero.stdout.txt",
        );
}
