//! Reserved integration test module for subagent CN.
//!
//! Ownership boundary for agent CN:
//! - tests/integration/test-runner/test_runner_stdlib_cn_set_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cn_set_tests/**
//! - tests/integration/testdata/test_std_agent_cn/**
//! - tests/support/test_std_agent_cn/** (optional)
//!
...
fn run_cn_stdlib_success(project_name: &str, test_body: &str, snapshot_path: &str) {
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cn_set_tests/cn_stdlib_set_c5_roundtrip_restores_single_and_double_action_out_lists.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cn_set_tests/cn_stdlib_set_c5_to_empty_cell_breaks_vm_out_actions_bug.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cn_set_tests/cn_stdlib_parse_out_actions_direct_empty_cell_returns_empty_list.stdout.txt",
    );
}
