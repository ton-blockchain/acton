...
//! - tests/integration/test-runner/test_runner_stdlib_dj_vm_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dj_vm_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dj_vm_tests/dj_stdlib_vm_set_block_and_logical_time_are_independent_in_c7_slots.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_dj_vm_tests/dj_stdlib_vm_set_logical_then_block_time_preserves_slot_isolation_in_fixture_project.stdout.txt",
        );
}
