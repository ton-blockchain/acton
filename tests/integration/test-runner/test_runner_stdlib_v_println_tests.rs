...
//! - tests/integration/test-runner/test_runner_stdlib_v_println_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_v_println_tests/**
...
fn println_and_println1_support_hex_and_ton_formatters() {
    run_stdlib_io_case(
        ...
        "#,
        "integration/snapshots/test-runner/test_runner_stdlib_v_println_tests/v_stdlib_println_and_println1_support_hex_and_ton_formatters.stdout.txt",
    );
}
...
fn eprintln_reports_into_test_stderr_block() {
    run_stdlib_io_case(
        ...
        "#,
        "integration/snapshots/test-runner/test_runner_stdlib_v_println_tests/v_stdlib_eprintln_reports_into_test_stderr_block.stdout.txt",
    );
}
