...
//! - tests/integration/test-runner/test_runner_stdlib_ej_assert_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ej_assert_tests/**
...
"#
    ...
    ProjectBuilder::new("ej-stdlib-assert-not-equal-complex-tuple-map")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_ej_assert_tests/ej_stdlib_assert_not_equal_reports_diagnostics_for_complex_tuple_and_map_values.stdout.txt",
        );
}
