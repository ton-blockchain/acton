//! Reserved integration test module for subagent Z.
//!
//! Ownership boundary for agent Z:
//! - tests/integration/test-runner/test_runner_stdlib_z_env_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_z_env_tests/**
//! - tests/integration/testdata/test_std_agent_z/**
//! - tests/support/test_std_agent_z/** (optional)
//!
...
fn env_parses_int_bool_address_and_cell_in_supported_formats() {
    ...
    ProjectBuilder::new("z-stdlib-env-supported-formats")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_z_env_tests/z_stdlib_env_parses_int_bool_address_and_cell_in_supported_formats.stdout.txt",
        );
}
...
fn env_returns_null_for_invalid_inputs_and_missing_values() {
    ProjectBuilder::new("z-stdlib-env-invalid-inputs")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_z_env_tests/z_stdlib_env_returns_null_for_invalid_inputs_and_missing_values.stdout.txt",
        );
}
...
fn env_or_uses_defaults_only_for_null_paths() {
    ProjectBuilder::new("z-stdlib-env-or-defaults")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_z_env_tests/z_stdlib_env_or_uses_defaults_only_for_null_paths.stdout.txt",
        );
}
...
fn env_parses_user_friendly_address_form() {
    ProjectBuilder::new("z-stdlib-env-address-friendly-form")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_z_env_tests/z_stdlib_env_parses_user_friendly_address_form.stdout.txt",
        );
}
