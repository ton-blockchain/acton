...
//! - tests/integration/test-runner/test_runner_stdlib_dq_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dq_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dq_config_tests/dq_stdlib_config_storage_prices_set_initial_overwrites_zero_and_preserves_future_entries.stdout.txt",
    );
}
