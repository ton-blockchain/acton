...
//! - tests/integration/test-runner/test_runner_stdlib_bd_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bd_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bd_config_tests/bd_stdlib_config_set_gas_prices_extended_fields_keep_base_and_masterchain_independent.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bd_config_tests/bd_stdlib_config_set_gas_prices_for_basechain_does_not_change_masterchain_extended_fields.stdout.txt",
    );
}
