...
//! - tests/integration/test-runner/test_runner_stdlib_cu_out_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cu_out_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cu_out_tests/cu_stdlib_out_messages_at_cell_and_at_match_for_each_index_project_builder.stdout.txt",
    );
}
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_cu_out_tests/cu_stdlib_out_messages_at_cell_and_at_match_for_same_index_fixture_project.stdout.txt",
        );
}
