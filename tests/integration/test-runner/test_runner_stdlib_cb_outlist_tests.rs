...
//! - tests/integration/test-runner/test_runner_stdlib_cb_outlist_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cb_outlist_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cb_outlist_tests/cb_stdlib_outlist_to_be_send_message_at_incompatible_typed_payload_reports_exit_code.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cb_outlist_tests/cb_stdlib_outlist_to_be_send_message_at_fails_for_non_send_action.stdout.txt",
    );
}
