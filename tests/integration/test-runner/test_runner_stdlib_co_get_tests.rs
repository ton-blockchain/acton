...
//! Prefix: co_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_co_get_tests/**
...
"#
    ...
    ProjectBuilder::new("co-stdlib-get-deployed-code-project-builder")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_co_get_tests/co_stdlib_get_deployed_code_transitions_from_null_to_non_null_in_project_builder.stdout.txt",
        );
}
...
"#;
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_co_get_tests/co_stdlib_get_deployed_code_transitions_from_null_to_non_null_in_fixture_project.stdout.txt",
        );
}
