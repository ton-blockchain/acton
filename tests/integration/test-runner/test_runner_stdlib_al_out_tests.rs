//! Reserved integration test module for subagent AL.
//!
//! Ownership boundary for agent AL:
//! - tests/integration/test-runner/test_runner_stdlib_al_out_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/**
//! - tests/integration/testdata/test_std_agent_al/**
//! - tests/support/test_std_agent_al/** (optional)
//!
...
fn run_al_stdlib_success(project_name: &str, test_body: &str, snapshot_path: &str) {
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/al_stdlib_out_actions_list_traversal_preserves_reverse_order_and_kinds.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/al_stdlib_parse_out_actions_from_raw_c5_matches_vm_out_actions.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/al_stdlib_get_send_message_at_returns_null_for_non_send_entries.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/al_stdlib_get_send_message_body_at_reads_inline_body_left_branch.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/al_stdlib_get_send_message_body_at_reads_ref_body_right_branch.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/al_stdlib_get_send_message_body_at_returns_null_for_non_send_action.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/al_stdlib_out_message_out_actions_helper_returns_send_action_with_mode_and_body.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_al_out_tests/al_stdlib_get_send_message_helpers_return_null_for_reserve_and_change_library_actions.stdout.txt",
    );
}
