...
//! - tests/integration/test-runner/test_runner_stdlib_cg_to_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cg_to_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cg_to_tests/cg_stdlib_to_have_successful_deploy_rejects_non_deploy_success_transaction.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cg_to_tests/cg_stdlib_to_have_successful_deploy_failure_format_includes_expected_search_params.stdout.txt",
    );
}
