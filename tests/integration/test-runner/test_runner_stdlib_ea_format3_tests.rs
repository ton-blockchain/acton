...
//! - tests/integration/test-runner/test_runner_stdlib_ea_format3_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ea_format3_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ea_format3_tests/ea_stdlib_format3_mixed_placeholders_should_follow_template_order_bug.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ea_format3_tests/ea_stdlib_format3_escaped_braces_around_placeholder_should_collapse_bug.stdout.txt",
    );
}
