...
//! - tests/integration/test-runner/test_runner_stdlib_dd_find_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dd_find_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dd_find_tests/dd_stdlib_find_external_out_message_filters_by_type_and_source_across_transactions.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dd_find_tests/dd_stdlib_find_external_out_message_uses_body_type_per_send_result_list.stdout.txt",
    );
}
