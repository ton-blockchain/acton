...
//! - tests/integration/test-runner/test_runner_stdlib_by_expect_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_by_expect_tests/**
...
"#
    ...
    run_by_expect_suite("by-stdlib-expect-bool-pass", &source)
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_by_expect_tests/by_stdlib_expect_bool_matchers_pass_for_true_and_false_values.stdout.txt",
        );
}
...
"#
    ...
    run_by_expect_suite("by-stdlib-expect-bool-fail", &source)
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_by_expect_tests/by_stdlib_expect_bool_matcher_mismatch_reports_tuple_diff.stdout.txt",
        );
}
