//! Reserved for agent-df.
//! Prefix: df_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_df_net_tests/**
//! Agent-owned tests for net.sendSingle vs net.send first-result equivalence.
...
fn run_df_project_success(project_name: &str, test_body: &str, snapshot_path: &str) {
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_df_net_tests/df_stdlib_net_send_single_matches_net_send_first_result_transaction_and_action_in_project_builder.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_df_net_tests/df_stdlib_net_send_single_matches_net_send_first_result_transaction_and_action_in_fixture_project.stdout.txt",
        );
}
