...
//! - tests/integration/test-runner/test_runner_stdlib_bn_enable_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bn_enable_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bn_enable_tests/bn_stdlib_enable_broadcast_toggle_reflects_in_is_broadcasting.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bn_enable_tests/bn_stdlib_disable_broadcast_toggle_reflects_in_is_broadcasting.stdout.txt",
    );
}
