//! Reserved integration test module for subagent DS.
//!
//! Ownership boundary for agent DS:
//! - tests/integration/test-runner/test_runner_stdlib_ds_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ds_config_tests/**
//! - tests/integration/testdata/test_std_agent_ds/**
//! - tests/support/test_std_agent_ds/** (optional)
//!
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ds_config_tests/ds_stdlib_config_set_gas_prices_sequential_chain_updates_remain_isolated.stdout.txt",
    );
}
