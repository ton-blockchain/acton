...
//! - tests/integration/test-runner/test_runner_stdlib_bb_global_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bb_global_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bb_global_tests/bb_stdlib_global_version_roundtrip_persists_after_net_set_config.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bb_global_tests/bb_stdlib_global_version_typed_and_raw_reads_match_after_roundtrip.stdout.txt",
    );
}
