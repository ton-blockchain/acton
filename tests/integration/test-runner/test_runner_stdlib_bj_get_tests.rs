...
//! - tests/integration/test-runner/test_runner_stdlib_bj_get_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bj_get_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bj_get_tests/bj_stdlib_get_account_state_after_top_up_returns_account_info_with_expected_balance.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bj_get_tests/bj_stdlib_get_account_state_should_transition_from_null_to_non_null_after_top_up_bug.stdout.txt",
    );
}
