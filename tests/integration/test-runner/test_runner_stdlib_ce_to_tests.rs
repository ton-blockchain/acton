...
//! - tests/integration/test-runner/test_runner_stdlib_ce_to_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ce_to_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ce_to_tests/ce_stdlib_to_have_all_successful_txs_negative_reports_single_failed_tx.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_ce_to_tests/ce_stdlib_to_have_all_successful_txs_negative_reports_single_failed_tx_in_fixture.stdout.txt",
        );
}
