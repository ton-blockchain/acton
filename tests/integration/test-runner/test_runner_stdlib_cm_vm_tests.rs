...
//! - tests/integration/test-runner/test_runner_stdlib_cm_vm_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cm_vm_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cm_vm_tests/cm_stdlib_vm_set_c7_overwrites_slot_three_without_clobbering_neighbors.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_cm_vm_tests/cm_stdlib_vm_set_c7_repeated_reads_and_writes_preserve_unmodified_slots.stdout.txt",
        );
}
