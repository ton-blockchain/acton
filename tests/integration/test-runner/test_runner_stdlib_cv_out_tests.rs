...
//! Prefix: cv_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_cv_out_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cv_out_tests/cv_stdlib_out_action_send_message_load_message_and_generic_are_parity_for_inline_body.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_cv_out_tests/cv_stdlib_out_action_send_message_load_message_and_generic_are_parity_for_ref_body_in_fixture_project.stdout.txt",
        );
}
