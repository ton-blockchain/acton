...
//! - tests/integration/test-runner/test_runner_stdlib_ai_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ai_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ai_config_tests/ai_stdlib_config_raw_param_roundtrip_for_global_version_cell.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ai_config_tests/ai_stdlib_config_set_config_rejects_invalid_global_version_cell.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ai_config_tests/ai_stdlib_config_storage_prices_roundtrip_updates_initial_entry.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ai_config_tests/ai_stdlib_config_gas_prices_update_basechain_and_masterchain_independently.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ai_config_tests/ai_stdlib_config_msg_forward_prices_update_changes_forward_fee_opcode_result.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ai_config_tests/ai_stdlib_config_precompiled_contracts_roundtrip_and_duplicate_insert_guard.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ai_config_tests/ai_stdlib_config_gas_price_change_affects_run_get_method_result.stdout.txt",
    );
}
