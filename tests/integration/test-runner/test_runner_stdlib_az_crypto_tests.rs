//! Reserved integration test module for subagent AZ.
//!
//! Ownership boundary for agent AZ:
//! - tests/integration/test-runner/test_runner_stdlib_az_crypto_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_az_crypto_tests/**
//! - tests/integration/testdata/test_std_agent_az/**
//! - tests/support/test_std_agent_az/** (optional)
//!
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_az_crypto_tests/az_stdlib_crypto_fast_random_bytes_without_seed_is_deterministic_for_fixed_vm_time.stdout.txt",
    );
}
