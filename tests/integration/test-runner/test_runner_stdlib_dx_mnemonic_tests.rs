//! Reserved integration test module for subagent DX.
//!
//! Ownership boundary for agent DX:
//! - tests/integration/test-runner/test_runner_stdlib_dx_mnemonic_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dx_mnemonic_tests/**
//! - tests/integration/testdata/test_std_agent_dx/**
//! - tests/support/test_std_agent_dx/** (optional)
//!
...
fn run_dx_crypto_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dx_mnemonic_tests/dx_stdlib_mnemonic_to_keypair_is_deterministic_for_repeated_calls.stdout.txt",
    );
}
