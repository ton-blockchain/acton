...
//! - tests/integration/test-runner/test_runner_stdlib_av_fs_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_av_fs_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_av_fs_tests/av_stdlib_fs_read_file_normalizes_parent_segments_from_nested_paths.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_av_fs_tests/av_stdlib_fs_read_file_repeated_normalized_reads_are_stable.stdout.txt",
        );
}
