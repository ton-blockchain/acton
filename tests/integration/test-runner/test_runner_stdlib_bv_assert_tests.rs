...
//! - tests/integration/test-runner/test_runner_stdlib_bv_assert_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bv_assert_tests/**
...
"#,
    ...
    ProjectBuilder::new("bv-stdlib-assert-fail-custom-location")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bv_assert_tests/bv_stdlib_assert_fail_formats_message_and_custom_location_in_output.stdout.txt",
        );
}
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bv_assert_tests/bv_stdlib_assert_fail_honors_expected_exit_code_path_in_fixture_project.stdout.txt",
        );
}
