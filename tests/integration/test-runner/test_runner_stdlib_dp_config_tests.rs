...
//! - tests/integration/test-runner/test_runner_stdlib_dp_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dp_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dp_config_tests/dp_stdlib_config_storage_prices_get_initial_empty_dict_falls_back_to_zero_prices.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dp_config_tests/dp_stdlib_config_storage_prices_get_initial_missing_zero_key_in_non_empty_dict_falls_back_to_zero_prices.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dp_config_tests/dp_stdlib_config_storage_prices_get_initial_prefers_zero_key_when_present.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dp_config_tests/dp_stdlib_config_storage_prices_get_initial_missing_zero_key_has_no_side_effects.stdout.txt",
    );
}
