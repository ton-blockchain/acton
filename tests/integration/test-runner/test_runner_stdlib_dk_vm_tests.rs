...
//! - tests/integration/test-runner/test_runner_stdlib_dk_vm_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dk_vm_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dk_vm_tests/dk_stdlib_vm_get_config_unpacked_stays_stable_after_set_config_root_dict_mutation.stdout.txt",
    );
}
