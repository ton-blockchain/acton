...
//! Prefix: cx_stdlib_
//! Ownership: this file and tests/integration/snapshots/test-runner/test_runner_stdlib_cx_change_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cx_change_tests/cx_stdlib_change_library_decoding_via_parse_out_actions.stdout.txt",
    );
}
