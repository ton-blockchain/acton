...
//! - tests/integration/test-runner/test_runner_stdlib_w_fs_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_w_fs_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_w_fs_tests/w_stdlib_fs_read_file_returns_content_for_existing_and_normalized_paths.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_w_fs_tests/w_stdlib_fs_read_file_returns_null_for_missing_file.stdout.txt",
    );
}
