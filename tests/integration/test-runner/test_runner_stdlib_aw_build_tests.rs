...
//! - tests/integration/test-runner/test_runner_stdlib_aw_build_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_aw_build_tests/**
...
fn build_reads_explicit_boc_path_and_executes_runtime_code() {
    ...
    project
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_aw_build_tests/aw_stdlib_build_reads_explicit_boc_path_and_executes_runtime_code.stdout.txt",
        );
}
...
fn build_name_based_code_executes_in_fixture_runtime() {
    FixtureProject::load("basic")
        ...
        .assert_passed(2)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_aw_build_tests/aw_stdlib_build_name_based_code_executes_in_fixture_runtime.stdout.txt",
        );
}
