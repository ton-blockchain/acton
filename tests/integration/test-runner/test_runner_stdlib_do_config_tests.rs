...
//! - tests/integration/test-runner/test_runner_stdlib_do_config_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_do_config_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_do_config_tests/do_stdlib_config_global_version_roundtrip_supports_zero_values.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_do_config_tests/do_stdlib_config_global_version_roundtrip_supports_non_zero_values.stdout.txt",
    );
}
