...
//! - tests/integration/test-runner/test_runner_stdlib_bo_network_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bo_network_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bo_network_tests/bo_stdlib_network_random_address_reuses_identical_symbolic_name_bug.stdout.txt",
    );
}
