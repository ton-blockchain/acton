...
//! - tests/integration/test-runner/test_runner_stdlib_bg_run_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bg_run_tests/**
...
fn run_get_method_by_id_fails_for_undeployed_contract() {
    let snapshot_path = "integration/snapshots/test-runner/test_runner_stdlib_bg_run_tests/bg_stdlib_run_get_method_by_id_fails_for_undeployed_contract.stdout.txt";
...
fn run_get_method_by_id_fails_for_invalid_method_id_on_deployed_contract() {
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bg_run_tests/bg_stdlib_run_get_method_by_id_fails_for_invalid_method_id_on_deployed_contract.stdout.txt",
        );
}
