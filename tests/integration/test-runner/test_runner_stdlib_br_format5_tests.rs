...
//! - tests/integration/test-runner/test_runner_stdlib_br_format5_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_br_format5_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_br_format5_tests/br_stdlib_format5_mixed_specifiers_should_follow_placeholder_order_bug.stdout.txt",
    );
}
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_br_format5_tests/br_stdlib_format5_mixed_specifiers_should_follow_placeholder_order_in_fixture_project_bug.stdout.txt",
        );
}
