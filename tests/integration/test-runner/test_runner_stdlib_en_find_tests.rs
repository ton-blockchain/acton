...
//! - tests/integration/test-runner/test_runner_stdlib_en_find_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_en_find_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_en_find_tests/en_stdlib_find_external_out_message_typed_branch_reports_tuple_get_type_argument_compile_error.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_en_find_tests/en_stdlib_find_external_out_message_default_branch_reports_tuple_get_type_argument_compile_error.stdout.txt",
    );
}
