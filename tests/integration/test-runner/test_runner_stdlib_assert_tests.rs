//! Integration tests for AC assert helper coverage.
//!
//! Ownership boundary for agent AC:
//! - tests/integration/test-runner/test_runner_stdlib_assert_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_assert/**
...
"#,
    ...
    ProjectBuilder::new("ac-stdlib-assert-consumes-less-than2-pass")
        ...
        "integration/snapshots/test-runner/test_runner_stdlib_assert/ac_stdlib_assert_consumes_less_than2_returns_function_result_when_within_limit.stdout.txt",
        );
}
...
"#,
    ...
    ProjectBuilder::new("ac-stdlib-assert-consumes-less-than-fail")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_assert/ac_stdlib_assert_consumes_less_than_reports_human_readable_gas_failure.stdout.txt",
        );
}
...
"#,
    ...
    ProjectBuilder::new("ac-stdlib-decimal-default-formatting")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_assert/ac_stdlib_expect_to_equal_decimal_formats_negative_fraction_values_in_failure.stdout.txt",
        );
}
...
"#,
    ...
    ProjectBuilder::new("ac-stdlib-decimal-custom-message-location")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_assert/ac_stdlib_assert_equal_decimal_uses_custom_message_and_location_from_arguments.stdout.txt",
        );
}
...
"#,
    ...
    ProjectBuilder::new("ac-stdlib-assert-not-equal-failure")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_assert/ac_stdlib_assert_not_equal_failure_surfaces_ffi_not_equal_branch_details.stdout.txt",
        );
}
