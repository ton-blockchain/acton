...
//! - tests/integration/test-runner/test_runner_stdlib_bi_wait_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bi_wait_tests/**
...
"#
    ...
    ProjectBuilder::new("bi-stdlib-wait-for-transaction-emulation-noop")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bi_wait_tests/bi_stdlib_wait_for_transaction_returns_true_in_emulation_mode.stdout.txt",
        );
}
