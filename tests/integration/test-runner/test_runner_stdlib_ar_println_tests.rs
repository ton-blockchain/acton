...
//! - tests/integration/test-runner/test_runner_stdlib_ar_println_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ar_println_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ar_println_tests/ar_stdlib_println_formats_nested_tuple_and_struct_values.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ar_println_tests/ar_stdlib_println1_formats_nested_tuple_and_struct_values_via_placeholder_pipeline.stdout.txt",
    );
}
