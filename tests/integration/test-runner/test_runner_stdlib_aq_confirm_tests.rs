...
//! - tests/integration/test-runner/test_runner_stdlib_aq_confirm_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_aq_confirm_tests/**
...
fn confirm_default_true_with_help_message_ignores_empty_input_bug() {
    ...
    command
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_aq_confirm_tests/aq_stdlib_confirm_default_true_with_help_message_ignores_empty_input_bug.stdout.txt",
        );
}
