...
//! - tests/integration/test-runner/test_runner_stdlib_cy_out_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_cy_out_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cy_out_tests/cy_stdlib_out_action_from_tuple_rejects_single_item_tuple.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_cy_out_tests/cy_stdlib_out_action_from_tuple_rejects_oversized_tuple_in_fixture_project.stdout.txt",
        );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_cy_out_tests/cy_stdlib_parse_out_actions_rejects_node_without_prev_ref.stdout.txt",
