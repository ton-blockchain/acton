...
//! - tests/integration/test-runner/test_runner_stdlib_bz_expect_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_bz_expect_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_bz_expect_tests/bz_stdlib_expect_address_matchers_accept_internal_none_and_external_addresses.stdout.txt",
    );
}
...
"#,
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_bz_expect_tests/bz_stdlib_expect_address_matchers_report_assertion_failures_for_wrong_kinds.stdout.txt",
        );
}
