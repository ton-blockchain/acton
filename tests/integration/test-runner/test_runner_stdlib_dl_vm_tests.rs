...
//! - tests/integration/test-runner/test_runner_stdlib_dl_vm_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_dl_vm_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_dl_vm_tests/dl_stdlib_vm_set_config_unpacked_empty_tuple_reports_tuple_index_diagnostic.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/test_runner_stdlib_dl_vm_tests/dl_stdlib_vm_set_config_unpacked_single_item_tuple_reports_tuple_index_diagnostic_in_fixture_project.stdout.txt",
        );
}
