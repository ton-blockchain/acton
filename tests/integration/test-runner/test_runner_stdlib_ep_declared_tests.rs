...
//! - tests/integration/test-runner/test_runner_stdlib_ep_declared_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_ep_declared_tests/**
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ep_declared_tests/ep_stdlib_declared_pack_prefix_helpers_direct_calls_return_expected_values.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_ep_declared_tests/ep_stdlib_transaction_expect_matchers_use_default_and_typed_declared_pack_prefix_paths.stdout.txt",
    );
}
