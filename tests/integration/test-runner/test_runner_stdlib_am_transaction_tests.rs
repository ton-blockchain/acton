//! Reserved integration test module for subagent AM.
//!
//! Ownership boundary for agent AM:
//! - tests/integration/test-runner/test_runner_stdlib_am_transaction_tests.rs
//! - tests/integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/**
//! - tests/integration/testdata/test_std_agent_am/**
//! - tests/support/test_std_agent_am/** (optional)
//!
...
fn with_am_source(test_body: &str) -> String {
    format!("{AM_IMPORTS}\n{test_body}\n")
}

fn run_am_success_case(project_name: &str, test_body: &str, snapshot_path: &str) {
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/am_stdlib_transaction_load_body_and_load_in_msg_extract_typed_payload_and_endpoints.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/am_stdlib_transaction_load_body_reports_exit_code63_for_mismatched_message_type.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/am_stdlib_transaction_load_in_msg_reports_exit_code63_for_mismatched_message_type.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/am_stdlib_transaction_get_used_gas_matches_send_result_for_root_and_child_transactions.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/am_stdlib_transaction_get_used_gas_reports_skipped_compute_phase_for_undeployed_destination.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/am_stdlib_transaction_get_action_fee_matches_transaction_description_and_none_branch.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/am_stdlib_transaction_get_account_address_defaults_to_basechain_and_supports_masterchain_override.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/test_runner_stdlib_am_transaction_tests/am_stdlib_transaction_varuint7_roundtrip_for_storage_used_large_values_bug.stdout.txt",
    );
}
