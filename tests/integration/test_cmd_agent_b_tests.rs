...
#[test]
fn b_test_cmd_cli_reporter_overrides_config_reporter() {
...
#[test]
fn b_test_cmd_teamcity_escapes_special_characters_in_test_names() {
...
#[test]
fn b_test_cmd_junit_merge_creates_only_single_output_file() {
...
#[test]
fn b_test_cmd_coverage_and_junit_reporter_work_together() {
...
#[test]
fn b_test_cmd_cli_coverage_format_overrides_config_coverage_format() {
