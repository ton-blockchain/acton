//! Reserved integration test module for subagent BE.
//!
//! Ownership boundary for agent BE:
//! - tests/integration/test_std_agent_be_tests.rs
//! - tests/integration/snapshots/test_std_agent_be/**
//! - tests/integration/testdata/test_std_agent_be/**
//! - tests/support/test_std_agent_be/** (optional)
//!
...
#[test]
fn be_stdlib_config_set_msg_forward_prices_keeps_basechain_and_masterchain_isolated() {
...
"#,
        "integration/snapshots/test_std_agent_be/be_stdlib_config_set_msg_forward_prices_keeps_basechain_and_masterchain_isolated.stdout.txt",
    );
}
