...
//! - tests/integration/test_lib_agent_t_tests.rs
//! - tests/integration/snapshots/test_lib_agent_t/**
//! - tests/integration/testdata/test_lib_agent_t/**
//! - tests/support/test_lib_agent_t/** (optional)
//!
...
#[test]
fn t_lib_api_fmt_supports_mixed_hex_ton_and_plain_placeholders() {
    ProjectBuilder::new("t-lib-api-fmt-mixed-placeholders")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_lib_agent_t/t_lib_api_fmt_supports_mixed_hex_ton_and_plain_placeholders.stdout.txt",
        );
}

#[test]
fn t_lib_api_fmt_plain_and_hex_placeholders_should_follow_argument_order_bug() {
...
#[test]
fn t_lib_api_env_bool_parsing_handles_case_numeric_falsey_and_missing() {
    ProjectBuilder::new("t-lib-api-env-bool-edge-cases")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test_lib_agent_t/t_lib_api_env_bool_parsing_handles_case_numeric_falsey_and_missing.stdout.txt",
        );
}

#[test]
fn t_lib_api_env_or_uses_defaults_for_invalid_int_address_and_cell_values() {
    ProjectBuilder::new("t-lib-api-env-or-invalid-fallbacks")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test_lib_agent_t/t_lib_api_env_or_uses_defaults_for_invalid_int_address_and_cell_values.stdout.txt",
        );
}

#[test]
fn t_lib_api_env_rejects_unsupported_target_types_with_clear_error() {
