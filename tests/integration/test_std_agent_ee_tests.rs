//! Reserved integration test module for subagent EE.
//!
//! Ownership boundary for agent EE:
//! - tests/integration/test_std_agent_ee_tests.rs
//! - tests/integration/snapshots/test_std_agent_ee/**
//! - tests/integration/testdata/test_std_agent_ee/**
//! - tests/support/test_std_agent_ee/** (optional)
//!
...
fn ee_map_project(name: &str, test_cases: &str) -> crate::support::project::Project {
...
#[test]
fn ee_stdlib_expect_map_to_have_length_accepts_empty_and_single_entry_maps() {
    ee_map_project(
    ...
    .assert_snapshot_matches(
        "integration/snapshots/test_std_agent_ee/ee_stdlib_expect_map_to_have_length_accepts_empty_and_single_entry_maps.stdout.txt",
    );
}

#[test]
fn ee_stdlib_expect_map_to_have_length_reports_boundary_mismatch_for_single_entry_map() {
    ee_map_project(
    ...
    .assert_failed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test_std_agent_ee/ee_stdlib_expect_map_to_have_length_reports_boundary_mismatch_for_single_entry_map.stdout.txt",
    );
}
