//! Reserved integration test module for subagent DN.
//!
//! Ownership boundary for agent DN:
//! - tests/integration/test_std_agent_dn_tests.rs
//! - tests/integration/snapshots/test_std_agent_dn/**
//! - tests/integration/testdata/test_std_agent_dn/**
//! - tests/support/test_std_agent_dn/** (optional)
//!
...
#[test]
fn dn_stdlib_config_get_msg_forward_prices_returns_per_chain_values_after_both_writes() {
...
"#,
        "integration/snapshots/test_std_agent_dn/dn_stdlib_config_get_msg_forward_prices_returns_per_chain_values_after_both_writes.stdout.txt",
    );
}
