//! Reserved integration test module for subagent W.
//!
//! Ownership boundary for agent W:
//! - tests/integration/test_std_agent_w_tests.rs
//! - tests/integration/snapshots/test_std_agent_w/**
//! - tests/integration/testdata/test_std_agent_w/**
//! - tests/support/test_std_agent_w/** (optional)
//!
...
#[test]
fn w_stdlib_fs_read_file_returns_content_for_existing_and_normalized_paths() {
    run_fs_case(
...
"#,
        "integration/snapshots/test_std_agent_w/w_stdlib_fs_read_file_returns_content_for_existing_and_normalized_paths.stdout.txt",
    );
}

#[test]
fn w_stdlib_fs_read_file_returns_null_for_missing_file() {
    run_fs_case(
...
"#,
        "integration/snapshots/test_std_agent_w/w_stdlib_fs_read_file_returns_null_for_missing_file.stdout.txt",
    );
}
