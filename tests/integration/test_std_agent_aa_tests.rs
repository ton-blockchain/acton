//! Reserved integration test module for subagent AA.
//!
//! Ownership boundary for agent AA:
//! - tests/integration/test_std_agent_aa_tests.rs
//! - tests/integration/snapshots/test_std_agent_aa/**
//! - tests/integration/testdata/test_std_agent_aa/**
//! - tests/support/test_std_agent_aa/** (optional)
//!
...
#[test]
fn aa_stdlib_maybe_some_none_unwrap_and_unwrap_or_follow_documented_semantics() {
    run_maybe_success(
...
"#,
        "integration/snapshots/test_std_agent_aa/aa_stdlib_maybe_some_none_unwrap_and_unwrap_or_follow_documented_semantics.stdout.txt",
    );
}

#[test]
fn aa_stdlib_maybe_unwrap_on_none_throws_exit_code_7() {
    run_maybe_failure(
...
"#,
        "integration/snapshots/test_std_agent_aa/aa_stdlib_maybe_unwrap_on_none_throws_exit_code_7.stdout.txt",
    );
}
