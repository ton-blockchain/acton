//! Reserved integration test module for subagent CE.
//!
//! Ownership boundary for agent CE:
//! - tests/integration/test_std_agent_ce_tests.rs
//! - tests/integration/snapshots/test_std_agent_ce/**
//! - tests/integration/testdata/test_std_agent_ce/**
//! - tests/support/test_std_agent_ce/** (optional)
//!
...
#[test]
fn ce_stdlib_to_have_all_successful_txs_negative_reports_single_failed_tx() {
...
"#,
        "integration/snapshots/test_std_agent_ce/ce_stdlib_to_have_all_successful_txs_negative_reports_single_failed_tx.stdout.txt",
    );
}

#[test]
fn ce_stdlib_to_have_all_successful_txs_negative_reports_single_failed_tx_in_fixture() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_ce/ce_stdlib_to_have_all_successful_txs_negative_reports_single_failed_tx_in_fixture.stdout.txt",
        );
}
