...
//! Prefix: df_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_df/**
...
"#,
        "integration/snapshots/test_std_agent_df/df_stdlib_net_send_single_matches_net_send_first_result_transaction_and_action_in_project_builder.stdout.txt",
    );
}
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_df/df_stdlib_net_send_single_matches_net_send_first_result_transaction_and_action_in_fixture_project.stdout.txt",
        );
}
