...
//! Prefix: db_stdlib_
//! Ownership: this file and tests/integration/snapshots/test_std_agent_db/**
...
#[test]
fn db_stdlib_transaction_load_body_decodes_nested_payload_from_inbound_message() {
...
"#,
        "integration/snapshots/test_std_agent_db/db_stdlib_transaction_load_body_decodes_nested_payload_from_inbound_message.stdout.txt",
    );
}

#[test]
fn db_stdlib_transaction_load_body_decodes_nested_payload_in_fixture_project() {
...
"#
    ...
    fixture
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test_std_agent_db/db_stdlib_transaction_load_body_decodes_nested_payload_in_fixture_project.stdout.txt",
        );
}
