...
impl ValidatorStats {
    ...
    /// Timestamp of the latest synchronized masterchain block.
    pub fn masterchain_block_time(&self) -> Result<u64> {
        self.value_u64("masterchainblocktime")
    }
}
...
mod tests {
    ...
    fn parses_noisy_key_and_stats_output() {
        ...
        assert_eq!(stats.masterchain_block_time().unwrap(), 1_787_985_860);
    }
